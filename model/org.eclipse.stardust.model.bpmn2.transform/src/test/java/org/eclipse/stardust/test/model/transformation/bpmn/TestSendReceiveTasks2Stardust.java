...
public class TestSendReceiveTasks2Stardust extends Bpmn2StardustTestSuite {
    ...
    public void testSendTask() {
        final String modelFile = TEST_BPMN_MODEL_DIR + "SendAndReceiveTask.bpmn";
        final String fileOutput = getResourceFilePath(TEST_MODEL_OUTPUT_DIR) + "testSendAndReceiveTask.xpdl";
