 ...
 * <ul>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getApplicationType <em>Application Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getApplicationContextType <em>Application Context Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getTriggerType <em>Trigger Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getEventConditionType <em>Event Condition Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getEventActionType <em>Event Action Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getModeler <em>Modeler</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getQualityControl <em>Quality Control</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getConditionalPerformer <em>Conditional Performer</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getProcessDefinition <em>Process Definition</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getExternalPackages <em>External Packages</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getTypeDeclarations <em>Type Declarations</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getLinkType <em>Link Type</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getView <em>View</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getCarnotVersion <em>Carnot Version</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getModelOID <em>Model OID</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getOid <em>Oid</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.ModelTypeImpl#getVendor <em>Vendor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelTypeImpl extends EObjectImpl implements ModelType
{
   ...
   public NotificationChain basicSetDescription(DescriptionType newDescription, NotificationChain msgs) {
      ...
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__DESCRIPTION, oldDescription, newDescription);
   ...
   public void setDescription(DescriptionType newDescription) {
      if (newDescription != description)
      {
         ...
         if (description != null)
            msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__DESCRIPTION, null, msgs);
         if (newDescription != null)
            msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__DESCRIPTION, null, msgs);
         msgs = basicSetDescription(newDescription, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__DESCRIPTION, newDescription, newDescription));
   }
   ...
   public EList<AttributeType> getAttribute() {
      if (attribute == null)
      {
         attribute = new EObjectContainmentEList<AttributeType>(AttributeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__ATTRIBUTE);
      }
      return attribute;
   }
   ...
   public EList<DataTypeType> getDataType() {
      if (dataType == null)
      {
         dataType = new EObjectContainmentEList<DataTypeType>(DataTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__DATA_TYPE);
      }
      return dataType;
   }
   ...
   public EList<ApplicationTypeType> getApplicationType() {
      ...
      {
         applicationType = new EObjectContainmentEList<ApplicationTypeType>(ApplicationTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__APPLICATION_TYPE);
      }
   ...
   public EList<ApplicationContextTypeType> getApplicationContextType() {
      ...
      {
         applicationContextType = new EObjectContainmentEList<ApplicationContextTypeType>(ApplicationContextTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__APPLICATION_CONTEXT_TYPE);
      }
   ...
   public EList<TriggerTypeType> getTriggerType() {
      if (triggerType == null)
      {
         triggerType = new EObjectContainmentEList<TriggerTypeType>(TriggerTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__TRIGGER_TYPE);
      }
      return triggerType;
   }
   ...
   public EList<EventConditionTypeType> getEventConditionType() {
      ...
      {
         eventConditionType = new EObjectContainmentEList<EventConditionTypeType>(EventConditionTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__EVENT_CONDITION_TYPE);
      }
   ...
   public EList<EventActionTypeType> getEventActionType() {
      ...
      {
         eventActionType = new EObjectContainmentEList<EventActionTypeType>(EventActionTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__EVENT_ACTION_TYPE);
      }
   ...
   public EList<DataType> getData() {
      if (data == null)
      {
         data = new EObjectContainmentEList<DataType>(DataType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__DATA);
      }
      return data;
   }
   ...
   public EList<ApplicationType> getApplication() {
      if (application == null)
      {
         application = new EObjectContainmentEList<ApplicationType>(ApplicationType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__APPLICATION);
      }
      return application;
   }
   ...
   public EList<ModelerType> getModeler() {
      if (modeler == null)
      {
         modeler = new EObjectContainmentEList<ModelerType>(ModelerType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__MODELER);
      }
      return modeler;
   }
   ...
   public NotificationChain basicSetQualityControl(QualityControlType newQualityControl, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__QUALITY_CONTROL, oldQualityControl, newQualityControl);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setQualityControl(QualityControlType newQualityControl)
   {
      if (newQualityControl != qualityControl)
      {
         ...
         if (qualityControl != null)
            msgs = ((InternalEObject)qualityControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__QUALITY_CONTROL, null, msgs);
         if (newQualityControl != null)
            msgs = ((InternalEObject)newQualityControl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__QUALITY_CONTROL, null, msgs);
         msgs = basicSetQualityControl(newQualityControl, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__QUALITY_CONTROL, newQualityControl, newQualityControl));
   }
   ...
   public EList<RoleType> getRole() {
      if (role == null)
      {
         role = new EObjectContainmentEList<RoleType>(RoleType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__ROLE);
      }
      return role;
   }
   ...
   public EList<OrganizationType> getOrganization() {
      ...
      {
         organization = new EObjectContainmentEList<OrganizationType>(OrganizationType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__ORGANIZATION);
      }
      return organization;
   }
   ...
   public EList<ConditionalPerformerType> getConditionalPerformer() {
      ...
      {
         conditionalPerformer = new EObjectContainmentEList<ConditionalPerformerType>(ConditionalPerformerType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__CONDITIONAL_PERFORMER);
      }
   ...
   public EList<ProcessDefinitionType> getProcessDefinition() {
      ...
      {
         processDefinition = new EObjectContainmentEList<ProcessDefinitionType>(ProcessDefinitionType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__PROCESS_DEFINITION);
      }
   ...
   public NotificationChain basicSetExternalPackages(ExternalPackages newExternalPackages, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__EXTERNAL_PACKAGES, oldExternalPackages, newExternalPackages);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setExternalPackages(ExternalPackages newExternalPackages)
   {
      if (newExternalPackages != externalPackages)
      {
         ...
         if (externalPackages != null)
            msgs = ((InternalEObject)externalPackages).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__EXTERNAL_PACKAGES, null, msgs);
         if (newExternalPackages != null)
            msgs = ((InternalEObject)newExternalPackages).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__EXTERNAL_PACKAGES, null, msgs);
         msgs = basicSetExternalPackages(newExternalPackages, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__EXTERNAL_PACKAGES, newExternalPackages, newExternalPackages));
   }
    ...
    */
	public NotificationChain basicSetScript(ScriptType newScript, NotificationChain msgs) {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__SCRIPT, oldScript, newScript);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
    ...
    */
	public void setScript(ScriptType newScript) {
      if (newScript != script)
      {
         NotificationChain msgs = null;
         if (script != null)
            msgs = ((InternalEObject)script).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__SCRIPT, null, msgs);
         if (newScript != null)
            msgs = ((InternalEObject)newScript).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__SCRIPT, null, msgs);
         msgs = basicSetScript(newScript, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__SCRIPT, newScript, newScript));
   }
   ...
   public NotificationChain basicSetTypeDeclarations(TypeDeclarationsType newTypeDeclarations, NotificationChain msgs) {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__TYPE_DECLARATIONS, oldTypeDeclarations, newTypeDeclarations);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setTypeDeclarations(TypeDeclarationsType newTypeDeclarations) {
      if (newTypeDeclarations != typeDeclarations)
      {
         ...
         if (typeDeclarations != null)
            msgs = ((InternalEObject)typeDeclarations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__TYPE_DECLARATIONS, null, msgs);
         if (newTypeDeclarations != null)
            msgs = ((InternalEObject)newTypeDeclarations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotWorkflowModelPackage.MODEL_TYPE__TYPE_DECLARATIONS, null, msgs);
         msgs = basicSetTypeDeclarations(newTypeDeclarations, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__TYPE_DECLARATIONS, newTypeDeclarations, newTypeDeclarations));
   }
   ...
   public EList<DiagramType> getDiagram() {
      if (diagram == null)
      {
         diagram = new EObjectContainmentEList<DiagramType>(DiagramType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__DIAGRAM);
      }
      return diagram;
   }
   ...
   public EList<LinkTypeType> getLinkType() {
      if (linkType == null)
      {
         linkType = new EObjectContainmentEList<LinkTypeType>(LinkTypeType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__LINK_TYPE);
      }
      return linkType;
   }
   ...
   public EList<ViewType> getView() {
      if (view == null)
      {
         view = new EObjectContainmentEList<ViewType>(ViewType.class, this, CarnotWorkflowModelPackage.MODEL_TYPE__VIEW);
      }
      return view;
   }
   ...
   public void setAuthor(String newAuthor) {
      ...
      author = newAuthor;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__AUTHOR, oldAuthor, author));
   }
   ...
   public void setCarnotVersion(String newCarnotVersion) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__CARNOT_VERSION, oldCarnotVersion, carnotVersion));
   }
   ...
   public void setCreated(String newCreated) {
      ...
      created = newCreated;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__CREATED, oldCreated, created));
   }
   ...
   public void setId(String newId) {
      ...
      idESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__ID, oldId, id, !oldIdESet));
   }
   ...
   public void unsetId() {
      ...
      idESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.MODEL_TYPE__ID, oldId, ID_EDEFAULT, oldIdESet));
   }
   ...
   public void setModelOID(int newModelOID) {
      ...
      modelOIDESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__MODEL_OID, oldModelOID, modelOID, !oldModelOIDESet));
   }
   ...
   public void unsetModelOID() {
      ...
      modelOIDESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.MODEL_TYPE__MODEL_OID, oldModelOID, MODEL_OID_EDEFAULT, oldModelOIDESet));
   }
   ...
   public void setName(String newName) {
      ...
      nameESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__NAME, oldName, name, !oldNameESet));
   }
   ...
   public void unsetName() {
      ...
      nameESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.MODEL_TYPE__NAME, oldName, NAME_EDEFAULT, oldNameESet));
   }
   ...
   public void setOid(long newOid) {
      ...
      oidESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__OID, oldOid, oid, !oldOidESet));
   }
   ...
   public void unsetOid() {
      ...
      oidESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.MODEL_TYPE__OID, oldOid, OID_EDEFAULT, oldOidESet));
   }
   ...
   public void setVendor(String newVendor) {
      ...
      vendor = newVendor;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.MODEL_TYPE__VENDOR, oldVendor, vendor));
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID)
      {
         ...
         case CarnotWorkflowModelPackage.MODEL_TYPE__QUALITY_CONTROL:
         ...
         case CarnotWorkflowModelPackage.MODEL_TYPE__TYPE_DECLARATIONS:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == IExtensibleElement.class)
      {
         ...
         {
            case CarnotWorkflowModelPackage.MODEL_TYPE__ATTRIBUTE: return CarnotWorkflowModelPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == IExtensibleElement.class)
      {
         ...
         {
            case CarnotWorkflowModelPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE: return CarnotWorkflowModelPackage.MODEL_TYPE__ATTRIBUTE;
            default: return -1;
         }
      }
