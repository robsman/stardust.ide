 ...
 * <ul>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getReferingToConnections <em>Refering To Connections</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getReferingFromConnections <em>Refering From Connections</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getSourceAnchor <em>Source Anchor</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getTargetAnchor <em>Target Anchor</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getRouting <em>Routing</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getActivitySymbol <em>Activity Symbol</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.DataMappingConnectionTypeImpl#getDataSymbol <em>Data Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DataMappingConnectionTypeImpl extends EObjectImpl implements DataMappingConnectionType
{
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   {
      return CarnotWorkflowModelPackage.Literals.DATA_MAPPING_CONNECTION_TYPE;
   }
   ...
   public void setElementOid(long newElementOid)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
   }
   ...
   public void unsetElementOid()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
   }
   ...
   public void setBorderColor(String newBorderColor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__BORDER_COLOR, oldBorderColor, borderColor));
   }
   ...
   public void setFillColor(String newFillColor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__FILL_COLOR, oldFillColor, fillColor));
   }
   ...
   public void setRouting(RoutingType newRouting)
   {
      ...
      routingESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ROUTING, oldRouting, routing, !oldRoutingESet));
   }
   ...
   public void unsetRouting()
   {
      ...
      routingESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ROUTING, oldRouting, ROUTING_EDEFAULT, oldRoutingESet));
   }
   ...
   public EList<Coordinates> getCoordinates()
   {
      if (coordinates == null)
      {
         coordinates = new EObjectContainmentEList<Coordinates>(Coordinates.class, this, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__COORDINATES);
      }
      return coordinates;
   }
   ...
   public void setStyle(String newStyle)
   {
      ...
      style = newStyle;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__STYLE, oldStyle, style));
   }
   ...
   public EList<RefersToConnectionType> getReferingToConnections()
   {
      ...
      {
         referingToConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_TO_CONNECTIONS, CarnotWorkflowModelPackage.REFERS_TO_CONNECTION_TYPE__TO);
      }
   ...
   public EList<RefersToConnectionType> getReferingFromConnections()
   {
      ...
      {
         referingFromConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS, CarnotWorkflowModelPackage.REFERS_TO_CONNECTION_TYPE__FROM);
      }
   ...
   public void setSourceAnchor(String newSourceAnchor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, sourceAnchor, !oldSourceAnchorESet));
   }
   ...
   public void unsetSourceAnchor()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, SOURCE_ANCHOR_EDEFAULT, oldSourceAnchorESet));
   }
   ...
   public void setTargetAnchor(String newTargetAnchor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, targetAnchor, !oldTargetAnchorESet));
   }
   ...
   public void unsetTargetAnchor()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, TARGET_ANCHOR_EDEFAULT, oldTargetAnchorESet));
   }
   ...
   public NotificationChain basicSetActivitySymbol(ActivitySymbolType newActivitySymbol, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ACTIVITY_SYMBOL, oldActivitySymbol, newActivitySymbol);
   ...
   public void setActivitySymbol(ActivitySymbolType newActivitySymbol)
   {
      if (newActivitySymbol != activitySymbol)
      {
         ...
         if (activitySymbol != null)
            msgs = ((InternalEObject)activitySymbol).eInverseRemove(this, CarnotWorkflowModelPackage.ACTIVITY_SYMBOL_TYPE__DATA_MAPPINGS, ActivitySymbolType.class, msgs);
         if (newActivitySymbol != null)
            msgs = ((InternalEObject)newActivitySymbol).eInverseAdd(this, CarnotWorkflowModelPackage.ACTIVITY_SYMBOL_TYPE__DATA_MAPPINGS, ActivitySymbolType.class, msgs);
         msgs = basicSetActivitySymbol(newActivitySymbol, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ACTIVITY_SYMBOL, newActivitySymbol, newActivitySymbol));
   }
   ...
   public NotificationChain basicSetDataSymbol(DataSymbolType newDataSymbol, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__DATA_SYMBOL, oldDataSymbol, newDataSymbol);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setDataSymbol(DataSymbolType newDataSymbol)
   {
      if (newDataSymbol != dataSymbol)
      {
         NotificationChain msgs = null;
         if (dataSymbol != null)
            msgs = ((InternalEObject)dataSymbol).eInverseRemove(this, CarnotWorkflowModelPackage.DATA_SYMBOL_TYPE__DATA_MAPPINGS, DataSymbolType.class, msgs);
         if (newDataSymbol != null)
            msgs = ((InternalEObject)newDataSymbol).eInverseAdd(this, CarnotWorkflowModelPackage.DATA_SYMBOL_TYPE__DATA_MAPPINGS, DataSymbolType.class, msgs);
         msgs = basicSetDataSymbol(newDataSymbol, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__DATA_SYMBOL, newDataSymbol, newDataSymbol));
   }
   ...
   {
      setDataSymbol((DataSymbolType) nodeSymbol);
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingToConnections()).basicAdd(otherEnd, msgs);
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingFromConnections()).basicAdd(otherEnd, msgs);
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ACTIVITY_SYMBOL:
            if (activitySymbol != null)
               msgs = ((InternalEObject)activitySymbol).eInverseRemove(this, CarnotWorkflowModelPackage.ACTIVITY_SYMBOL_TYPE__DATA_MAPPINGS, ActivitySymbolType.class, msgs);
            return basicSetActivitySymbol((ActivitySymbolType)otherEnd, msgs);
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__DATA_SYMBOL:
            if (dataSymbol != null)
               msgs = ((InternalEObject)dataSymbol).eInverseRemove(this, CarnotWorkflowModelPackage.DATA_SYMBOL_TYPE__DATA_MAPPINGS, DataSymbolType.class, msgs);
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         ...
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__COORDINATES:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
      switch (featureID)
      {
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ELEMENT_OID:
            return getElementOid();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__BORDER_COLOR:
            return getBorderColor();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__FILL_COLOR:
            return getFillColor();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__STYLE:
            return getStyle();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
            return getReferingToConnections();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
            return getReferingFromConnections();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__SOURCE_ANCHOR:
            return getSourceAnchor();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__TARGET_ANCHOR:
            return getTargetAnchor();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__ROUTING:
            return getRouting();
         case CarnotWorkflowModelPackage.DATA_MAPPING_CONNECTION_TYPE__COORDINATES:
