 ...
 * <ul>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getReferingToConnections <em>Refering To Connections</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getReferingFromConnections <em>Refering From Connections</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getSourceAnchor <em>Source Anchor</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getTargetAnchor <em>Target Anchor</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getRouting <em>Routing</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getOrganizationSymbol <em>Organization Symbol</em>}</li>
 *   <li>{@link org.eclipse.stardust.model.xpdl.carnot.impl.WorksForConnectionTypeImpl#getParticipantSymbol <em>Participant Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WorksForConnectionTypeImpl extends EObjectImpl implements WorksForConnectionType
{
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   {
      return CarnotWorkflowModelPackage.Literals.WORKS_FOR_CONNECTION_TYPE;
   }
   ...
   public void setElementOid(long newElementOid)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
   }
   ...
   public void unsetElementOid()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
   }
   ...
   public void setBorderColor(String newBorderColor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__BORDER_COLOR, oldBorderColor, borderColor));
   }
   ...
   public void setFillColor(String newFillColor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__FILL_COLOR, oldFillColor, fillColor));
   }
   ...
   public void setRouting(RoutingType newRouting)
   {
      ...
      routingESet = true;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ROUTING, oldRouting, routing, !oldRoutingESet));
   }
   ...
   public void unsetRouting()
   {
      ...
      routingESet = false;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ROUTING, oldRouting, ROUTING_EDEFAULT, oldRoutingESet));
   }
   ...
   public EList<Coordinates> getCoordinates()
   {
      if (coordinates == null)
      {
         coordinates = new EObjectContainmentEList<Coordinates>(Coordinates.class, this, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__COORDINATES);
      }
      return coordinates;
   }
   ...
   public void setStyle(String newStyle)
   {
      ...
      style = newStyle;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__STYLE, oldStyle, style));
   }
   ...
   public EList<RefersToConnectionType> getReferingToConnections()
   {
      ...
      {
         referingToConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__REFERING_TO_CONNECTIONS, CarnotWorkflowModelPackage.REFERS_TO_CONNECTION_TYPE__TO);
      }
   ...
   public EList<RefersToConnectionType> getReferingFromConnections()
   {
      ...
      {
         referingFromConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS, CarnotWorkflowModelPackage.REFERS_TO_CONNECTION_TYPE__FROM);
      }
   ...
   public void setSourceAnchor(String newSourceAnchor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, sourceAnchor, !oldSourceAnchorESet));
   }
   ...
   public void unsetSourceAnchor()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, SOURCE_ANCHOR_EDEFAULT, oldSourceAnchorESet));
   }
   ...
   public void setTargetAnchor(String newTargetAnchor)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, targetAnchor, !oldTargetAnchorESet));
   }
   ...
   public void unsetTargetAnchor()
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, TARGET_ANCHOR_EDEFAULT, oldTargetAnchorESet));
   }
   ...
   public NotificationChain basicSetOrganizationSymbol(OrganizationSymbolType newOrganizationSymbol, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ORGANIZATION_SYMBOL, oldOrganizationSymbol, newOrganizationSymbol);
   ...
   public void setOrganizationSymbol(OrganizationSymbolType newOrganizationSymbol)
   {
      if (newOrganizationSymbol != organizationSymbol)
      {
         ...
         if (organizationSymbol != null)
            msgs = ((InternalEObject)organizationSymbol).eInverseRemove(this, CarnotWorkflowModelPackage.ORGANIZATION_SYMBOL_TYPE__MEMBER_ROLES, OrganizationSymbolType.class, msgs);
         if (newOrganizationSymbol != null)
            msgs = ((InternalEObject)newOrganizationSymbol).eInverseAdd(this, CarnotWorkflowModelPackage.ORGANIZATION_SYMBOL_TYPE__MEMBER_ROLES, OrganizationSymbolType.class, msgs);
         msgs = basicSetOrganizationSymbol(newOrganizationSymbol, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__ORGANIZATION_SYMBOL, newOrganizationSymbol, newOrganizationSymbol));
   }
   ...
   public NotificationChain basicSetParticipantSymbol(RoleSymbolType newParticipantSymbol, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__PARTICIPANT_SYMBOL, oldParticipantSymbol, newParticipantSymbol);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setParticipantSymbol(RoleSymbolType newParticipantSymbol)
   {
      if (newParticipantSymbol != participantSymbol)
      {
         ...
         if (participantSymbol != null)
            msgs = ((InternalEObject)participantSymbol).eInverseRemove(this, CarnotWorkflowModelPackage.ROLE_SYMBOL_TYPE__ORGANIZATION_MEMBERSHIPS, RoleSymbolType.class, msgs);
         if (newParticipantSymbol != null)
            msgs = ((InternalEObject)newParticipantSymbol).eInverseAdd(this, CarnotWorkflowModelPackage.ROLE_SYMBOL_TYPE__ORGANIZATION_MEMBERSHIPS, RoleSymbolType.class, msgs);
         msgs = basicSetParticipantSymbol(newParticipantSymbol, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__PARTICIPANT_SYMBOL, newParticipantSymbol, newParticipantSymbol));
   }
   ...
   {
      setParticipantSymbol((RoleSymbolType) nodeSymbol);
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingToConnections()).basicAdd(otherEnd, msgs);
         case CarnotWorkflowModelPackage.WORKS_FOR_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
