      ...
      IItemPropertySource		
{
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupSymbolType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_GroupSymbolType_type") + " " + groupSymbolType.getElementOid();
   }
