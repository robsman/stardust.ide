...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.GroupSymbolType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupSymbolTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public GroupSymbolTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   /**
    * This returns GroupSymbolType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupSymbolType")); //$NON-NLS-1$
   }
   ...
   {
      GroupSymbolType groupSymbolType = (GroupSymbolType)object;
      return getString("_UI_GroupSymbolType_type") + " " + groupSymbolType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(GroupSymbolType.class))
      {
