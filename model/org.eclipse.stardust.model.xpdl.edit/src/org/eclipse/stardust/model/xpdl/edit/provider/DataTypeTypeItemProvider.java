   ...
   protected void addAccessPathEditorPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_accessPathEditor_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_accessPathEditor_feature", "_UI_DataTypeType_type"),
   ...
   protected void addEvaluatorPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_evaluator_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_evaluator_feature", "_UI_DataTypeType_type"),
   ...
   protected void addInstanceClassPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_instanceClass_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_instanceClass_feature", "_UI_DataTypeType_type"),
   ...
   protected void addPanelClassPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_panelClass_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_panelClass_feature", "_UI_DataTypeType_type"),
   ...
   protected void addReadablePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_readable_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_readable_feature", "_UI_DataTypeType_type"),
   ...
   protected void addStorageStrategyPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_storageStrategy_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_storageStrategy_feature", "_UI_DataTypeType_type"),
   ...
   protected void addValidatorClassPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_validatorClass_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_validatorClass_feature", "_UI_DataTypeType_type"),
   ...
   protected void addValueCreatorPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_valueCreator_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_valueCreator_feature", "_UI_DataTypeType_type"),
   ...
   protected void addWritablePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_writable_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_writable_feature", "_UI_DataTypeType_type"),
   ...
   protected void addDataPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataTypeType_data_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataTypeType_data_feature", "_UI_DataTypeType_type"),
