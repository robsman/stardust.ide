...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.ViewType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
      ...
      IItemPropertySource		
{
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
   {
      if (childrenFeatures == null)
      {
         ...
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.VIEW_TYPE__DESCRIPTION);
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.VIEW_TYPE__VIEW);
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.VIEW_TYPE__VIEWABLE);
      }
   ...
   protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
   {
      ...
      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.VIEW_TYPE__DESCRIPTION,
             CarnotWorkflowModelFactory.eINSTANCE.createDescriptionType()));

      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.VIEW_TYPE__VIEW,
             CarnotWorkflowModelFactory.eINSTANCE.createViewType()));

      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.VIEW_TYPE__VIEWABLE,
             CarnotWorkflowModelFactory.eINSTANCE.createViewableType()));
   }
