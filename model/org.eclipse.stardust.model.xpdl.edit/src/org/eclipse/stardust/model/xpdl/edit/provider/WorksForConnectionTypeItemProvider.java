      ...
      IItemPropertySource		
{
   ...
   protected void addOrganizationSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_WorksForConnectionType_organizationSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_WorksForConnectionType_organizationSymbol_feature", "_UI_WorksForConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   protected void addParticipantSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_WorksForConnectionType_participantSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_WorksForConnectionType_participantSymbol_feature", "_UI_WorksForConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/WorksForConnectionType")); //$NON-NLS-1$
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_WorksForConnectionType_type") + " " + worksForConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
