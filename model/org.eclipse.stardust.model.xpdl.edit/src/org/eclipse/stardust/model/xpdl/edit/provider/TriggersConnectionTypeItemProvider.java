...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.TriggersConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggersConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public TriggersConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
   {
      if (itemPropertyDescriptors == null)
      {
         ...
         addStartEventSymbolPropertyDescriptor(object);
   ...
   /**
    * This adds a property descriptor for the Start Event Symbol feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addStartEventSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
   ...
   /**
    * This returns TriggersConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(TriggersConnectionType.class))
      {
