...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.PartOfConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartOfConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public PartOfConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
   {
      if (itemPropertyDescriptors == null)
      {
         ...
         addSuborganizationSymbolPropertyDescriptor(object);
      }
   ...
   protected void addOrganizationSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PartOfConnectionType_organizationSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_PartOfConnectionType_organizationSymbol_feature", "_UI_PartOfConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.PART_OF_CONNECTION_TYPE__ORGANIZATION_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This adds a property descriptor for the Suborganization Symbol feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addSuborganizationSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PartOfConnectionType_suborganizationSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_PartOfConnectionType_suborganizationSymbol_feature", "_UI_PartOfConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.PART_OF_CONNECTION_TYPE__SUBORGANIZATION_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns PartOfConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PartOfConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      PartOfConnectionType partOfConnectionType = (PartOfConnectionType)object;
      return getString("_UI_PartOfConnectionType_type") + " " + partOfConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(PartOfConnectionType.class))
      {
