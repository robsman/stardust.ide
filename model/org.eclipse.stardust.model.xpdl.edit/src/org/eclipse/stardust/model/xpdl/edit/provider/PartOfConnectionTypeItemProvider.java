      ...
      IItemPropertySource		
{
   ...
   protected void addOrganizationSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PartOfConnectionType_organizationSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PartOfConnectionType_organizationSymbol_feature", "_UI_PartOfConnectionType_type"),
   ...
   protected void addSuborganizationSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PartOfConnectionType_suborganizationSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PartOfConnectionType_suborganizationSymbol_feature", "_UI_PartOfConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PartOfConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_PartOfConnectionType_type") + " " + partOfConnectionType.getElementOid();
   }
