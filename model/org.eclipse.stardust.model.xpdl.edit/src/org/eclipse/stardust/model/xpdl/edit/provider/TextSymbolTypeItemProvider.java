      ...
      IItemPropertySource		
{
   ...
   protected void addTextPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_TextSymbolType_text_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_TextSymbolType_text_feature", "_UI_TextSymbolType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/TextSymbolType")); //$NON-NLS-1$
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_TextSymbolType_type") + " " + textSymbolType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
