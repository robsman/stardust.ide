      ...
      IItemPropertySource		
{
   ...
   protected void addTeamSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_TeamLeadConnectionType_teamSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_TeamLeadConnectionType_teamSymbol_feature", "_UI_TeamLeadConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   protected void addTeamLeadSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_TeamLeadConnectionType_teamLeadSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_TeamLeadConnectionType_teamLeadSymbol_feature", "_UI_TeamLeadConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/TeamLeadConnectionType")); //$NON-NLS-1$
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_TeamLeadConnectionType_type") + " " + teamLeadConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
