...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.AnnotationSymbolType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationSymbolTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public AnnotationSymbolTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
   {
      if (childrenFeatures == null)
      {
         ...
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.ANNOTATION_SYMBOL_TYPE__TEXT);
      }
   ...
   /**
    * This returns AnnotationSymbolType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(AnnotationSymbolType.class))
      {
   ...
   protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
   {
      ...
      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.ANNOTATION_SYMBOL_TYPE__TEXT,
             CarnotWorkflowModelFactory.eINSTANCE.createTextType()));
   }
