      ...
      IItemPropertySource		
{
   ...
   protected void addFromPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_RefersToConnectionType_from_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_RefersToConnectionType_from_feature", "_UI_RefersToConnectionType_type"),
   ...
   protected void addToPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_RefersToConnectionType_to_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_RefersToConnectionType_to_feature", "_UI_RefersToConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/RefersToConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_RefersToConnectionType_type") + " " + refersToConnectionType.getElementOid();
   }
