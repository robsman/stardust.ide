...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.RefersToConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RefersToConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public RefersToConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addFromPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_RefersToConnectionType_from_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_RefersToConnectionType_from_feature", "_UI_RefersToConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.REFERS_TO_CONNECTION_TYPE__FROM,
             true,
             false,
             false,
             null,
   ...
   protected void addToPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_RefersToConnectionType_to_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_RefersToConnectionType_to_feature", "_UI_RefersToConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.REFERS_TO_CONNECTION_TYPE__TO,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns RefersToConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/RefersToConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      RefersToConnectionType refersToConnectionType = (RefersToConnectionType)object;
      return getString("_UI_RefersToConnectionType_type") + " " + refersToConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(RefersToConnectionType.class))
      {
