      ...
      IItemPropertySource		
{
   ...
   protected void addTypePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_AbstractEventAction_type_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_AbstractEventAction_type_feature", "_UI_AbstractEventAction_type"),
   ...
   public String getText(Object object)
   {
      ...
      return label == null || label.length() == 0 ?
         getString("_UI_AbstractEventAction_type") :
         getString("_UI_AbstractEventAction_type") + " " + label;
   }
