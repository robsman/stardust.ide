...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.AbstractEventAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractEventActionItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public AbstractEventActionItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addTypePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_AbstractEventAction_type_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_AbstractEventAction_type_feature", "_UI_AbstractEventAction_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.ABSTRACT_EVENT_ACTION__TYPE,
             true,
             false,
             false,
             null,
   ...
   {
      String label = ((AbstractEventAction)object).getName();
      return label == null || label.length() == 0 ?
         getString("_UI_AbstractEventAction_type") : //$NON-NLS-1$
         getString("_UI_AbstractEventAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(AbstractEventAction.class))
      {
