...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.DataMappingConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataMappingConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public DataMappingConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
   {
      if (itemPropertyDescriptors == null)
      {
         ...
         addDataSymbolPropertyDescriptor(object);
      }
   ...
   protected void addActivitySymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataMappingConnectionType_activitySymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_DataMappingConnectionType_activitySymbol_feature", "_UI_DataMappingConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.DATA_MAPPING_CONNECTION_TYPE__ACTIVITY_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This adds a property descriptor for the Data Symbol feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addDataSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataMappingConnectionType_dataSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_DataMappingConnectionType_dataSymbol_feature", "_UI_DataMappingConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.DATA_MAPPING_CONNECTION_TYPE__DATA_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns DataMappingConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/DataMappingConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      DataMappingConnectionType dataMappingConnectionType = (DataMappingConnectionType)object;
      return getString("_UI_DataMappingConnectionType_type") + " " + dataMappingConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(DataMappingConnectionType.class))
      {
