      ...
      IItemPropertySource		
{
   ...
   protected void addActivitySymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataMappingConnectionType_activitySymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataMappingConnectionType_activitySymbol_feature", "_UI_DataMappingConnectionType_type"),
   ...
   protected void addDataSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_DataMappingConnectionType_dataSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_DataMappingConnectionType_dataSymbol_feature", "_UI_DataMappingConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/DataMappingConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_DataMappingConnectionType_type") + " " + dataMappingConnectionType.getElementOid();
   }
