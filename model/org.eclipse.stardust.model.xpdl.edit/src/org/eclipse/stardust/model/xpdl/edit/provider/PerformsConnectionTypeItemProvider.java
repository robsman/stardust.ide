...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.PerformsConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformsConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public PerformsConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addActivitySymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PerformsConnectionType_activitySymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_PerformsConnectionType_activitySymbol_feature", "_UI_PerformsConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.PERFORMS_CONNECTION_TYPE__ACTIVITY_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   protected void addParticipantSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PerformsConnectionType_participantSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_PerformsConnectionType_participantSymbol_feature", "_UI_PerformsConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.PERFORMS_CONNECTION_TYPE__PARTICIPANT_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns PerformsConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PerformsConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      PerformsConnectionType performsConnectionType = (PerformsConnectionType)object;
      return getString("_UI_PerformsConnectionType_type") + " " + performsConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(PerformsConnectionType.class))
      {
