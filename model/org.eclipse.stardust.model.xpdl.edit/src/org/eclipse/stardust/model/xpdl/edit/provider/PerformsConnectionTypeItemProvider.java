      ...
      IItemPropertySource		
{
   ...
   protected void addActivitySymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PerformsConnectionType_activitySymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PerformsConnectionType_activitySymbol_feature", "_UI_PerformsConnectionType_type"),
   ...
   protected void addParticipantSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_PerformsConnectionType_participantSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_PerformsConnectionType_participantSymbol_feature", "_UI_PerformsConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/PerformsConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_PerformsConnectionType_type") + " " + performsConnectionType.getElementOid();
   }
