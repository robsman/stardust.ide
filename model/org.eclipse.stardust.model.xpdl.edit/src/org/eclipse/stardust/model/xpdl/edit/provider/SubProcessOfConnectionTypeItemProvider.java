      ...
      IItemPropertySource		
{
   ...
   protected void addProcessSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_SubProcessOfConnectionType_processSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_SubProcessOfConnectionType_processSymbol_feature", "_UI_SubProcessOfConnectionType_type"),
   ...
   protected void addSubprocessSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_SubProcessOfConnectionType_subprocessSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_SubProcessOfConnectionType_subprocessSymbol_feature", "_UI_SubProcessOfConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/SubProcessOfConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_SubProcessOfConnectionType_type") + " " + subProcessOfConnectionType.getElementOid();
   }
