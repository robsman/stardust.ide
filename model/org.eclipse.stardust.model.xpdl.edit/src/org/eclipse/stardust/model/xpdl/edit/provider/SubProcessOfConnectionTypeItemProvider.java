...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.SubProcessOfConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubProcessOfConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public SubProcessOfConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
   {
      if (itemPropertyDescriptors == null)
      {
         ...
         addProcessSymbolPropertyDescriptor(object);
         addSubprocessSymbolPropertyDescriptor(object);
      }
   ...
   /**
    * This adds a property descriptor for the Process Symbol feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addProcessSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_SubProcessOfConnectionType_processSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_SubProcessOfConnectionType_processSymbol_feature", "_UI_SubProcessOfConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.SUB_PROCESS_OF_CONNECTION_TYPE__PROCESS_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This adds a property descriptor for the Subprocess Symbol feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addSubprocessSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_SubProcessOfConnectionType_subprocessSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_SubProcessOfConnectionType_subprocessSymbol_feature", "_UI_SubProcessOfConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.SUB_PROCESS_OF_CONNECTION_TYPE__SUBPROCESS_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns SubProcessOfConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/SubProcessOfConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      SubProcessOfConnectionType subProcessOfConnectionType = (SubProcessOfConnectionType)object;
      return getString("_UI_SubProcessOfConnectionType_type") + " " + subProcessOfConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(SubProcessOfConnectionType.class))
      {
