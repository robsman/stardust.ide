      ...
      IItemPropertySource		
{
   ...
   protected void addInTransitionsPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_IFlowObjectSymbol_inTransitions_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_IFlowObjectSymbol_inTransitions_feature", "_UI_IFlowObjectSymbol_type"),
   ...
   protected void addOutTransitionsPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_IFlowObjectSymbol_outTransitions_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_IFlowObjectSymbol_outTransitions_feature", "_UI_IFlowObjectSymbol_type"),
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_IFlowObjectSymbol_type") + " " + iFlowObjectSymbol.getElementOid();
   }
