...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.IFlowObjectSymbol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IFlowObjectSymbolItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public IFlowObjectSymbolItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addInTransitionsPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_IFlowObjectSymbol_inTransitions_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_IFlowObjectSymbol_inTransitions_feature", "_UI_IFlowObjectSymbol_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.IFLOW_OBJECT_SYMBOL__IN_TRANSITIONS,
             true,
             false,
             false,
             null,
   ...
   protected void addOutTransitionsPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_IFlowObjectSymbol_outTransitions_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_IFlowObjectSymbol_outTransitions_feature", "_UI_IFlowObjectSymbol_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.IFLOW_OBJECT_SYMBOL__OUT_TRANSITIONS,
             true,
             false,
             false,
             null,
   ...
   {
      IFlowObjectSymbol iFlowObjectSymbol = (IFlowObjectSymbol)object;
      return getString("_UI_IFlowObjectSymbol_type") + " " + iFlowObjectSymbol.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(IFlowObjectSymbol.class))
      {
