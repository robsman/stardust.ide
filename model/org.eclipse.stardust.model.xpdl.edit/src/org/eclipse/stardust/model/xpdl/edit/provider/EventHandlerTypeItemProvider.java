...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.EventHandlerType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventHandlerTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public EventHandlerTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
   {
      if (itemPropertyDescriptors == null)
      {
         ...
         addAutoBindPropertyDescriptor(object);
         addConsumeOnMatchPropertyDescriptor(object);
         addLogHandlerPropertyDescriptor(object);
         addTypePropertyDescriptor(object);
         addUnbindOnMatchPropertyDescriptor(object);
      }
   ...
   /**
    * This adds a property descriptor for the Auto Bind feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addAutoBindPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
   ...
   /**
    * This adds a property descriptor for the Consume On Match feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addConsumeOnMatchPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
   ...
   /**
    * This adds a property descriptor for the Log Handler feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addLogHandlerPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
   ...
   /**
    * This adds a property descriptor for the Unbind On Match feature.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   protected void addUnbindOnMatchPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
   {
      if (childrenFeatures == null)
      {
         ...
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.IACCESS_POINT_OWNER__ACCESS_POINT);
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__BIND_ACTION);
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__EVENT_ACTION);
         childrenFeatures.add(CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__UNBIND_ACTION);
      }
   ...
   /**
    * This returns EventHandlerType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(EventHandlerType.class))
      {
   ...
   protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
   {
      ...
      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.IACCESS_POINT_OWNER__ACCESS_POINT,
             CarnotWorkflowModelFactory.eINSTANCE.createAccessPointType()));

      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__BIND_ACTION,
             CarnotWorkflowModelFactory.eINSTANCE.createBindActionType()));

      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__EVENT_ACTION,
             CarnotWorkflowModelFactory.eINSTANCE.createEventActionType()));

      newChildDescriptors.add
         (createChildParameter
            (CarnotWorkflowModelPackage.Literals.EVENT_HANDLER_TYPE__UNBIND_ACTION,
