...
/**
 * This is the item provider adapter for a {@link org.eclipse.stardust.model.xpdl.edit.GenericLinkConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericLinkConnectionTypeItemProvider
      ...
      IItemPropertySource		
{
    ...
    * @generated
    */
   public GenericLinkConnectionTypeItemProvider(AdapterFactory adapterFactory)
   {
   ...
   protected void addLinkTypePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_linkType_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_linkType_feature", "_UI_GenericLinkConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.GENERIC_LINK_CONNECTION_TYPE__LINK_TYPE,
             true,
             false,
             false,
             null,
   ...
   protected void addSourceSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_sourceSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_sourceSymbol_feature", "_UI_GenericLinkConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.GENERIC_LINK_CONNECTION_TYPE__SOURCE_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   protected void addTargetSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_targetSymbol_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_targetSymbol_feature", "_UI_GenericLinkConnectionType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
             CarnotWorkflowModelPackage.Literals.GENERIC_LINK_CONNECTION_TYPE__TARGET_SYMBOL,
             true,
             false,
             false,
             null,
   ...
   /**
    * This returns GenericLinkConnectionType.gif.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericLinkConnectionType")); //$NON-NLS-1$
   }
   ...
   {
      GenericLinkConnectionType genericLinkConnectionType = (GenericLinkConnectionType)object;
      return getString("_UI_GenericLinkConnectionType_type") + " " + genericLinkConnectionType.getElementOid(); //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(GenericLinkConnectionType.class))
      {
