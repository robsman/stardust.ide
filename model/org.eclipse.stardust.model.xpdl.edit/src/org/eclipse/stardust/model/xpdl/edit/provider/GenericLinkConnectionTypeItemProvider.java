      ...
      IItemPropertySource		
{
   ...
   protected void addLinkTypePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_linkType_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_linkType_feature", "_UI_GenericLinkConnectionType_type"),
   ...
   protected void addSourceSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_sourceSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_sourceSymbol_feature", "_UI_GenericLinkConnectionType_type"),
   ...
   protected void addTargetSymbolPropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_GenericLinkConnectionType_targetSymbol_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_GenericLinkConnectionType_targetSymbol_feature", "_UI_GenericLinkConnectionType_type"),
   ...
   {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericLinkConnectionType"));
   }
   ...
   public String getText(Object object)
   {
      ...
      return getString("_UI_GenericLinkConnectionType_type") + " " + genericLinkConnectionType.getElementOid();
   }
