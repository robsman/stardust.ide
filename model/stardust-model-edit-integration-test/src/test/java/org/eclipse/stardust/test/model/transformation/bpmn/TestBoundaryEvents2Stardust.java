...
public class TestBoundaryEvents2Stardust extends Bpmn2StardustTestSuite {
    ...
    public void testBoundaryTimerEvent() {
        ...
        final String modelFile = "BoundaryTimerEvent.bpmn";

        ModelType model = transformModel(loadBpmnModel(modelFile));
    ...
    public void testBoundaryErrorEvent() {
        final String modelFile = "BoundaryErrorEvent.bpmn";
    ...
    public void testBoundarySplit() {
        final String modelFile = "BoundaryEventWithMultipleOutgoing.bpmn";
    ...
    public void testBoundaryOnRoutingActivityToGate() {
        final String modelFile = "BoundaryEventFollowedByGateway.bpmn";
    ...
    public void testMultipleBoundaryWithIndividualPath() {
        final String modelFile = "BoundaryEventMultipleDifferentExceptionalPath.bpmn";
    ...
    public void testMultipleBoundaryWithCommonPathToGateway() {
        final String modelFile = "BoundaryEventMultipleSameExceptionalPathToGateway.bpmn";
