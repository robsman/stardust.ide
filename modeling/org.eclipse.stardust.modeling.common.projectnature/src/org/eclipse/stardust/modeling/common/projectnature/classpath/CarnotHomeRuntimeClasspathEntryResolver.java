 ...
 * @version $Revision$
 */
public class CarnotHomeRuntimeClasspathEntryResolver
      implements IRuntimeClasspathEntryResolver
{
   public CarnotHomeRuntimeClasspathEntryResolver()
   {
   }
         ...
         IRuntimeClasspathEntry entry) throws CoreException
   {
      ...
      try
      {
         String decodedHomeFolder = new String(Base64.decode(path.toString().getBytes()));

         result = BpmClasspathUtils.getCarnotHomeRtClasspathEntries(decodedHomeFolder);
      }
