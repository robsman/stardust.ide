...
public class ParallelSplitAndSynchronizationTemplatePage extends WizardPage {
	...
	protected ParallelSplitAndSynchronizationTemplatePage(String pageName, String title, ImageDescriptor titleImage) {
