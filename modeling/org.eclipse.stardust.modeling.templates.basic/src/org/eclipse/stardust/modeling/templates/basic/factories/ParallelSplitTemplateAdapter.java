...
public class ParallelSplitTemplateAdapter implements ITemplate
   
{
   ITemplateFactory parentTemplateFactory;   
   
   public ParallelSplitTemplateAdapter(ITemplateFactory javaFactory)
   {
         ...
         DiagramType targetDiagram, EditPart editPart, int xHint, int yHint)
   {
      ...
      final ParallelSplitTemplateWizard wizard = new ParallelSplitTemplateWizard(editor, targetModel,
      ...
      WizardDialog dialog = new WizardDialog(Display.getCurrent().getActiveShell(), wizard) {
         ...
         {
            super.finishPressed();       
            ParallelSplitTemplateWizard w = (ParallelSplitTemplateWizard)wizard;
            if (w.isKilled()) {
