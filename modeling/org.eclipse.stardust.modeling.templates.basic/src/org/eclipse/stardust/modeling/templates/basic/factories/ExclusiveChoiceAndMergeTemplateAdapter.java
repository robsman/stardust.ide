...
public class ExclusiveChoiceAndMergeTemplateAdapter implements ITemplate
   
{
   ITemplateFactory parentTemplateFactory;   
   
   public ExclusiveChoiceAndMergeTemplateAdapter(ITemplateFactory javaFactory)
   {
         ...
         DiagramType targetDiagram, EditPart editPart, int xHint, int yHint)
   {
      ...
      final ExclusiveChoiceAndMergeTemplateWizard wizard = new ExclusiveChoiceAndMergeTemplateWizard(editor, targetModel,
      ...
      WizardDialog dialog = new WizardDialog(Display.getCurrent().getActiveShell(), wizard) {
         ...
         {
            super.finishPressed();       
            ExclusiveChoiceAndMergeTemplateWizard w = (ExclusiveChoiceAndMergeTemplateWizard)wizard;
            if (w.isKilled()) {
