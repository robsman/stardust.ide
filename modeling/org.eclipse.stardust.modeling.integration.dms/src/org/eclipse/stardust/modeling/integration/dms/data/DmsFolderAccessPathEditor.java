 ...
 * @version $Revision$
 */
public class DmsFolderAccessPathEditor extends AbstractDmsItemAccessPathEditor
      implements IAccessPathEditor
{
   ...
   {
      return DmsTypeUtils.newDmsFolderAccessPoint(model, null, data, DirectionType.INOUT_LITERAL);
   }
