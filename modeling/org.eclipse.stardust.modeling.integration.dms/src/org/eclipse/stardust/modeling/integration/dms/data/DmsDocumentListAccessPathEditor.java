 ...
 * @version $Revision$
 */
public class DmsDocumentListAccessPathEditor extends AbstractDmsItemAccessPathEditor
      implements IAccessPathEditor
{
   ...
   {
      return DmsTypeUtils.newDmsDocumentListAccessPoint(model, null, data, DirectionType.INOUT_LITERAL);
   }
