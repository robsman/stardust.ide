 ...
 * @author mgille
 */
public class MailPropertyPage extends AbstractModelElementPropertyPage implements
      IApplicationPropertyPage
{
   ...
   public void loadFieldsFromElement(IModelElementNodeSymbol symbol, IModelElement element)
   {
      ...
      this.createProcessHistoryLinkButton.setSelection(AttributeUtil.getBooleanValue(app,
            MailConstants.CREATE_PROCESS_HISTORY_LINK));
   ...
   public void loadElementFromFields(IModelElementNodeSymbol symbol, IModelElement element)
   {
      ...
      AttributeUtil.setAttribute(app, MailConstants.DEFAULT_MAIL_SERVER, mailServerText
            .getText().getText());
      AttributeUtil.setAttribute(app, MailConstants.DEFAULT_JNDI_SESSION, jndiSessionText
            .getText().getText());
      ...
      AttributeUtil.setBooleanAttribute(app,
            MailConstants.SUBJECT_INCLUDE_UNIQUE_IDENTIFIED,
            subjectUniqueIdentified.getSelection());
      AttributeUtil.setAttribute(app, MailConstants.DEFAULT_MAIL_CC, defaultCC.getText()
            .getText());
      AttributeUtil.setAttribute(app, MailConstants.DEFAULT_MAIL_BCC, defaultBCC
            .getText().getText());
      ...
      AttributeUtil.setAttribute(app, MailConstants.PLAIN_TEXT_TEMPLATE,
            plainTextTemplateText.getText().getText());
      AttributeUtil.setBooleanAttribute(app, MailConstants.CREATE_PROCESS_HISTORY_LINK,
            createProcessHistoryLinkButton.getSelection());
   ...
   public Control createBody(final Composite parent)
   {
      ...
      this.createProcessHistoryLinkButton = FormBuilder.createCheckBox(composite,
            Mail_Messages.CREATE_PROCESS_HISTORY_LINK_LABEL);
      ...
      String[] priorities = { Mail_Messages.PRIORITY_HIGHEST_VALUE,
            Mail_Messages.PRIORITY_HIGH_VALUE, Mail_Messages.PRIORITY_NORMAL_VALUE,
            Mail_Messages.PRIORITY_LOW_VALUE, Mail_Messages.PRIORITY_LOWEST_VALUE };
   ...
   private void testDefaultMailSettings()
   {
      try
      {
         ...
         InternetAddress fromAddress = new InternetAddress(defaultFromText.getText()
               .getText());
         msg.setFrom(fromAddress);

         msg.addRecipients(Message.RecipientType.TO, parseRecipientList(defaultToText
               .getText().getText()));
         if ( !StringUtils.isEmpty(defaultCC.getText().getText()))
         {
            msg.addRecipients(Message.RecipientType.CC, parseRecipientList(defaultCC
                  .getText().getText()));
         }
         if ( !StringUtils.isEmpty(defaultBCC.getText().getText()))
         {
            msg.addRecipients(Message.RecipientType.BCC, parseRecipientList(defaultBCC
                  .getText().getText()));
         }
