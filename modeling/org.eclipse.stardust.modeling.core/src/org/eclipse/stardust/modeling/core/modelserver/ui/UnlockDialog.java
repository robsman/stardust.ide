...
{         
   ...
   public UnlockDialog(RevertUtil util)
   {      
      super(util.getEditor().getSite().getShell());
   ...
   protected void configureShell(Shell shell)
   {
      ...
      shell.setText(Diagram_Messages.LB_REVERT_CHANGES);         
   }   
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      revertUtil.setUpdateContent(container);      
      ...
      viewer.addCheckStateListener(new ICheckStateListener()
      {
         public void checkStateChanged(CheckStateChangedEvent event) 
         {
            ...
            revertUtil.getEObjectsFromSelection(elements);
            validateSelection();
         }
      });      
      ...
      if (preCheckedElements != null)
      {
         ...
         revertUtil.getEObjectsFromSelection(preCheckedElements);
      }            
      validateSelection(); 
   ...
   class TableLabelProvider implements ITableLabelProvider, ITableColorProvider
   {
      ...
      public Image getColumnImage(Object element, int columnIndex)
      {
         ...
         {         
            ...
            {            
               ...
               return editor.getModelServer().getIcon(image, (EObject) element);
            }     
      ...
      public Color getForeground(Object element, int columnIndex)
      {
         if (element instanceof EObject)
         {
            ...
            CollisionInfo info = stateCache.getState((EObject) element);
            if (!(info.getState() == CollisionState.LOCKED_BY_USER))
            {
