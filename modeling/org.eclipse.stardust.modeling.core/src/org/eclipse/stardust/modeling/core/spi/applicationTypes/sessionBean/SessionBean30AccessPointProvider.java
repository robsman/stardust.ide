...
public class SessionBean30AccessPointProvider implements IAccessPointProvider
{
   public List createIntrinsicAccessPoint(IModelElement element)
   {
      ...
      String createMethodName = AttributeUtil.getAttributeValue(
      ...
      result.addAll(PlainJavaAccessPointProvider.getIntrinsicAccessPoints(
            (IExtensibleElement) element, className, createMethodName, true,
            null, DirectionType.IN_LITERAL, null, true));
