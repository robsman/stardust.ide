...
public class CreateConditionalPerformerAction extends SelectionAction
{
   private IModelElement performer;

   public CreateConditionalPerformerAction(IWorkbenchPart part)
   {
      super(part);
      setId(DiagramActionConstants.CREATE_CONDITIONAL_PERFORMER);
      setText(Diagram_Messages.TXT_NewConditionalPerformer);
   ...
   public void run()
   {
      ...
      CreationUtils.showInOutlineAndEdit(performer);
   }

   private CreateModelElementCommand createCommand()
   {
      IdFactory id = new IdFactory(Diagram_Messages.ID_ConditionalPerformer,
            Diagram_Messages.BASENAME_ConditionalPerformer);
