...
public class Diagram_Messages extends NLS {
	...
	public static String MSG_REMOVE_PERFORMANCE;
	...
	public static String NewWorkflowDiagramWizardPage_MSG_MustCreateProject;
	...
	public static String TXT_JOB_SearchingAccessPoints;
	...
	public static String MSG_FolderMustBeWritable;
	...
	public static String LB_ACTION_RemoveTransition;
	public static String LB_ACTION_ChangeJoinType;
	public static String LB_ACTION_ChangeSplitType;
	public static String ACTION_NAME;
	public static String BASENAME_View;
	public static String ACTION_NAME_DeleteView;
	public static String ERR_Error;
	public static String DESC_MasterForWorkflowModeling;
	public static String BASENAME_Administrator;
	public static String BASENAME_All;
	public static String DESC_InChargeOfAllWorkflowAdministrationAct;
	public static String DESC_InChargeAdministrationActivities;
	public static String DESC_LastActivityPerformer;
	public static String DESC_UserPerformingLastActivity;
	public static String DESC_StartingUser;
	public static String DESC_UserStartingCurrentProcess;
	public static String DESC_UserCurrentlyAttachedToActivityThread;
	public static String DESC_ProcessOID;
	public static String DESC_IDAssignedToCurrentProcess;
	public static String DESC_RootProcessOID;
	public static String DESC_IDAssignedToRootProcess;
	public static String DESC_CurrentDateLong;
	public static String DESC_CurrentLocale;
	public static String DESC_StringRepresentingCurrentLocale;
	public static String DESC_CurrentModel;
	public static String DESC_CarnotWizard;
	public static String DESC_CurrentModelLong;
	public static String NAME_DIAGRAM_Default;
	...
	public static String NAME_TASK_OpeningFileForEditing;
	...
	public static String MSG_FolderForNewModelMustBeSpecified;
	...
	public static String LB_ACTION_DelDataPath;
	public static String LB_ACTION_DelData;
	...
	public static String RELATIONSHIP_NAME_WorksFor;
	public static String RELATIONSHIP_NAME_PartOf;
	public static String EXECUTION_NAME_ExecutedBy;
	public static String EXECUTION_NAME_Performs;
	public static String BASENAME_RefersTo;
	...
	public static String LB_MenuManager_Implementation;
	public static String IMPL_ACTION_Route;
	public static String IMPL_ACTION_Manual;
	public static String IMPL_ACTION_Application;
	public static String IMPL_ACTION_Subprocess;
	...
	public static String LB_CONN_Transition;
	public static String DESC_CONN_CreatesNewTransition;
	public static String LB_CONNECTION_DataMapping;
	public static String DESC_CONN_CreatesNewDataMapping;
	public static String LB_CONN_ExecutedBy;
	public static String DESC_CONN_SpecifyExecutedApplication;
	public static String LB_CONN_Performs;
	public static String DESC_CONN_SpecifyPerformingParticipant;
	public static String LB_CONN_Annotate;
	public static String DESC_CONN_SpecifyTargetSymbol;
	...
	public static String LB_PALETTEDRAWER_ProcessItems;
	public static String LB_PALETTESTACK_Swimlane;
	public static String DESC_PALETTESTACK_CreateSwimlane;
	...
	public static String LB_PALETTESTACK_Start;
	public static String DESC_PALETTESTACK_CreateStartActivity;
	...
	public static String LB_TOOLENTRY_ProcessInterface;
	public static String DESC_TOOLENTRY_CreatesNewEndEvent;
	public static String DESC_TOOLENTRY_CreatesNewProcessInterface;
	...
	public static String LB_PALETTESTACK_Hierarchy;
	public static String DESC_PALETTESTACK_Hierarchy;
	public static String LB_CONN_WorksFor;
	public static String DESC_CONN_CreatesNewOrganizationMembAssociation;
	public static String LB_CONN_PartOf;
	public static String DESC_CONN_CreatesNewSuborganizationAssociation;
	...
	public static String LB_PALETTEDRAWER_Participants;
	...
	public static String LB_Route;
	public static String LB_Manual;
	public static String LB_Subprocess;
	public static String LB_Application;
	...
	public static String ERR_ValidationLabel;
	public static String WARN_ValidationLabel;
	public static String GENERAL_LABEL;
	public static String CONTROL_FLOW_LABEL;
	public static String GATEWAY_LABEL;
	public static String EVENT_HANDLER_LABEL;
	public static String CONDITION_TYPE_TIMER_LABEL;
	public static String CONDITION_TYPE_PROCESS_STATECHANGE_LABEL;
	public static String IN_DATA_MAPPINGS_LABEL;
	public static String OUT_DATA_MAPPINGS_LABEL;
	public static String CONDITIONAL_PERFORMER_LABEL;
	public static String DATA_LABEL;
	public static String TRIGGER_LABEL;
	public static String DATA_PATH_LABEL;
	public static String DATA_PATHS_LABEL;
	public static String VISUALIZATION_LABEL;
	public static String WARN_unableToResolve;
	public static String WARN_ambiguousDeclaration;
	public static String COL_NAME_Name;
	public static String NONINTERACTIVE_DATE_FORMAT;
	public static String INTERACTIVE_DATE_FORMAT;
	public static String msg_SearchingTypes;
	public static String TXT_MENU_MANAGER_Implementation;
	public static String LINK_TOOL_DESCRIPTION;
	public static String LB_PALETTESTACK_Links;
	public static String DESC_PALETTESTACK_Links;
	...
	public static String LB_Expiration;
	public static String LB_Licensed;
	public static String LB_Processors;
	public static String LB_LicensePath;
	...
	public static String PageTitle_General;
	public static String PageTitle_ControlFlow;
	public static String PageTitle_Transitions;
	public static String PageTitle_EventHandling;
	public static String PageTitle_Timer;
	public static String PageTitle_StateChange;
	public static String PageTitle_InDataMapping;
	public static String PageTitle_OutDataMapping;
	public static String PageTitle_Controlling;
	public static String PageTitle_ConditionalPerformer;
	public static String PageTitle_Data;
	public static String PageTitle_DataPath;
	public static String PageTitle_DataPaths;
	public static String PageTitle_Visualization;
	...
	public static String LB_CreateConnection;
	public static String LB_CreateTransition;
	public static String LB_CreateDataMapping;
	public static String LB_CreateExecutedBy;
	public static String LB_CreatePerforms;
	public static String LB_CreateWorksFor;
	public static String LB_CreateOrganizationHierarchy;
	public static String LB_CreatePartOf;
	...
	public static String MSG_DUPLICATE_ID;
	public static String MSG_NO_LOCKING_NOT_SHARED;
	public static String MSG_NO_LOCKING_LOCKED_BY_OTHER;
	public static String MSG_NOT_LOCKABLE;
	public static String MSG_CONNECTION_ACTION;

	public static String MSG_CONNECTION_ESTABLISHED;
	...
	public static String MSG_UPDATE_NEEDED;
	public static String LB_REFRESH_STATUS_JOB;
	public static String LB_REFRESH_TREE_JOB;
	public static String LB_CREATE_CACHE_JOB;
	public static String LB_CREATE_LOCKFILES_JOB;
	public static String LB_SHARE_JOB;
	...
	public static String LB_FORMBUILDER_Name;
	public static String LB_Measure;
	public static String LB_FORMBUILDER_ActionType;
	public static String LB_FORMBUILDER_Participants;
	...
	public static String LABEL_SyncSeparate;
	...
	public static String TXT_NAME;
	public static String TXT_HasMappingID;
	public static String TXT_HasApplicationPath;
	public static String TXT_HasPanelClass;
	public static String TXT_AccessPointProviderClass;
	public static String TXT_ValidatorClass;
	public static String TXT_Attributes;
	...
	public static String TAB_TXT_Request;
	public static String TAB_TXT_Response;
	public static String LB_QueueConnectionFactoryJNDI;
	public static String LB_QueueJNDI;
	public static String LB_MessageProviderTypeClass;
	public static String LB_MessageType;
	public static String LB_IncludeOIDHeaderFields;
	public static String COL_TXT_Location;
	public static String COL_TXT_Name;
	public static String COL_TXT_TRANSITION_CONDITION;

	public static String COL_TXT_Type;
	public static String COL_TXT_DefaultValue;

	public static String COL_TXT_DESCRIPTION;
	public static String B_Remove;
	public static String B_Up;
	public static String B_Down;
	public static String LB_MessageAcceptorTypeClass;
	public static String DATAGROUP_TXT_PlainJavaApplication;
	public static String FORMBUILDER_LB_Class;
	public static String B_Browse;
	public static String FORMBUILDER_LB_CompletionMethod;
	public static String FORMBUILDER_LB_Constructor;
	public static String DATAGROUP_SessionBeanApplication;
	public static String LB_RemoteInterfaceClassName;
	public static String LB_HomeInterfaceClassName;
	public static String LB_HomeInterfaceJNDIPath;
	public static String LB_LocalBinding;
	public static String LB_CompletionMethod;
	public static String LB_CreationMethod;
	public static String LB_ApplicationInstanceClass;
	public static String LB_PanelClass;
	public static String LB_Synchronous;
	public static String LB_AccessPointProviderClass;
	public static String TAB_TXT_Operation;
	public static String TAB_TXT_Parts;
	public static String TAB_TXT_Mappings_Templates;
	public static String B_Load;
	public static String LB_Service;
	public static String LB_Port;
	public static String LB_Operation;
	public static String LB_Style;
	public static String LB_Use;
	public static String GROUP_Addressing;
	public static String LB_IncludeWSAddressingEndpointReference;
	public static String LB_Implementation;
	public static String GROUP_Authentication;
	public static String LB_required;
	public static String LB_Mechanism;
	public static String LB_Variant;
	public static String COL_TXT_Mapped;
	public static String COL_TXT_Parts;
	public static String LB_TypeMappings;
	public static String COL_TXT_XML_TEXT_NODE;

	public static String COL_TXT_XMLType;
	public static String COL_TXT_JavaType;
	public static String LB_XMLTemplates;
	...
	public static String LB_AccessPathEvaluatorClass;
	public static String LB_AccessPathEditorClass;
	public static String LB_ValidatorClass;
	public static String LB_Attributes;
	public static String COL_TXT_Property;
	public static String COL_TXT_Value;
	...
	public static String TAB_ITEM_Basic;
	public static String TAB_ITEM_Visualization;
	public static String LB_ShowName;
	public static String LB_ShowRole;
	public static String LB_LineColor;
	public static String LINE_COMBO_black;
	public static String LB_LineType;
	public static String LINE_COMBO_NormalLine;
	public static String LB_StartSymbol;
	public static String LB_EndSymbol;
	public static String COMBO_withoutSymbol;
	public static String LB_SourceClass;
	public static String LB_SourceRole;
	public static String LB_SourceCardinality;
	public static String LB_TargetClass;
	public static String LB_TargetRole;
	public static String LB_TargetCardinality;
	...
	public static String MEASURE_TYPE_Money;
	public static String MEASURE_UNIT_EUR;
	public static String COL_NAME_Data;
	public static String BASENAME_DataPath;
	public static String BASENAME_FormalParameter;
	public static String CHECKED_IMAGE;
	public static String UNCHECKED_IMAGE;
	...
	public static String RoleGeneral_FORMBUILDER_LB_Cardinality;
	public static String CHECKBOX_ForkOnTraversal;
	public static String LB_Condition;
	...
	public static String COMBOBOX_No_External_Invocation;
	public static String COMBOBOX_WSDL_Invocation;
	public static String COMBOBOX_REST_Invocation;
	...
	public static String LB_PROCESSINTERFACE_WEBSERVICE_ENDPOINT;
	public static String LB_PROCESSINTERFACE_WSDLCODE;
	...
	public static String NAME_ACCESSPOINT_PreviousUser;
	public static String NAME_ACCESSPOINT_NewUser;
	...
	public static String MSG_FOR_ACTIVITY;

	public static String MSG_FOR_TRIGGER;

	public static String MSG_FROM_ACTIVITY;

	public static String MSG_FROM_THE_MD;
	...
	public static String TXT_ymdhms;
	...
	public static String BTN_JMS_Request;
	public static String Context_Request;
	public static String ContextResponse;

	public static String CSL_NULL_SCHEMA_FOR_TYPE_DECLARATION;
	public static String BTN_JMS_Response;
   ...
   public static String QUALITY_CONTROL_VALIDATION_NUMERIC;
