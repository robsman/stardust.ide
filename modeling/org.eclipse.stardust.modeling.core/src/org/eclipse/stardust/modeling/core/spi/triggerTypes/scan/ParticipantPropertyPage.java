...
public class ParticipantPropertyPage extends AbstractModelElementPropertyPage
{
   ...
   public void loadFieldsFromElement(IModelElementNodeSymbol symbol, IModelElement element)
   {
      ...
      wBndMgr.bind(labeledWidget, (IExtensibleElement) element,
            PredefinedConstants.MANUAL_TRIGGER_PARTICIPANT_ATT, participants);
         ...
         IModelElement element)
   {
      ...
      LaneParticipantCommandFactory.addSetPerformerCommands(command, trigger,
            newPerformer, originalPerformer, attribute, true, null);
      command.execute();
   }
   ...
   public Control createBody(Composite parent)
   {
      ...
      tableViewer.addSelectionChangedListener(new ISelectionChangedListener()
      {
         public void selectionChanged(SelectionChangedEvent event)
         {
            ...
            {
               IModelParticipant participant = (IModelParticipant) ((IStructuredSelection) event
      ...
      FormBuilder.createButton(parent, Diagram_Messages.UncheckButton,
            new SelectionAdapter()
            {
               public void widgetSelected(SelectionEvent e)
               {
                  ...
                  {
                     AttributeUtil.setReference(trigger,
                           PredefinedConstants.MANUAL_TRIGGER_PARTICIPANT_ATT, null);
