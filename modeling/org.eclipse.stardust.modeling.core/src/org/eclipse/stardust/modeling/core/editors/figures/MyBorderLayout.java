 ...
 *     Sungard - Improved some issues concerning default size and minimum size of figures
 *******************************************************************************/
...
public void layout(IFigure container) {
	...
	if (center != null && center.isVisible()) {
      ...
      // <custom_code> (fh)
      // Put the center figure in the middle of the area, without stretching.
      // code taken from bellow, where it is done for Y axis.
