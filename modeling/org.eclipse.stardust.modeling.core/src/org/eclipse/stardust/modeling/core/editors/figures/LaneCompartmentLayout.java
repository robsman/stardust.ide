...
/**
 * Basically this class defines a layout strategy on its own and could be implemented as a specialization of
 * AbstractLayout, but deriving from FlowLayout allows for {@link org.eclipse.gef.editpolicies.FlowLayoutEditPolicy}use
 * for the container.
 * 
 * @author rsauer
 * @version $Revision$
