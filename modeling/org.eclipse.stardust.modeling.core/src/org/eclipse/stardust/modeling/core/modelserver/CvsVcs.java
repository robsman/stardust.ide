...
public class CvsVcs implements Vcs
{
   public void add(IResource [] resources, IProgressMonitor monitor)
   {
   }

   public void lock(IResource[] resources, IProgressMonitor monitor)
   {
   }
   ...
   public void commit(IResource [] resources, String comment, boolean keepLock, IProgressMonitor monitor)
   {
   }
   ...
   public boolean isShared(IResource resource, boolean forceRemoteCheck)
   {
      return false;
   }
