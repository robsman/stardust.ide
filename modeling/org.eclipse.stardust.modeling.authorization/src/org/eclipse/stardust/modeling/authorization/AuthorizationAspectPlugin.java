 ...
 */
public class AuthorizationAspectPlugin extends AbstractUIPlugin
{
	private static AuthorizationAspectPlugin plugin;

	/**
	 * 
	 */
	public AuthorizationAspectPlugin()
	{
		plugin = this;
	}
	 ...
	 */
	public static AuthorizationAspectPlugin getDefault()
	{
		return plugin;
	}
