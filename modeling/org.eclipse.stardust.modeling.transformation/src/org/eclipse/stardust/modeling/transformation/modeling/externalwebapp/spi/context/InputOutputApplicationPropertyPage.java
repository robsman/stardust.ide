 ...
 */
public class InputOutputApplicationPropertyPage extends
      AbstractModelElementPropertyPage implements IApplicationPropertyPage
{
   ...
   public InputOutputApplicationPropertyPage()
   {
      super();
   ...
   {
      return controlsManager.create(parent, (IModelElement) getModelElement(), true, true);
   }
