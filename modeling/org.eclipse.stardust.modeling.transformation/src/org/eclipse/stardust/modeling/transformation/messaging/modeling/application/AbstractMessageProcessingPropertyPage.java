   ...
   extends AbstractModelElementPropertyPage
{
   ...
   protected void initializeTypeComboViewer(ApplicationType application)
   {
      ...
      TypesLabelProvider lp = (TypesLabelProvider) messageTypeComboViewer.getLabelProvider();
      lp.setModel(modelType);

      List<TypeDeclarationType> dataTypes = ModelUtils.getAllTypeDeclarations(modelType);
   ...
   protected void initializeMessageFormatComboViewer(IModelElement element)
   {
      ...
      {
         formatComboViewer.setSelection(new StructuredSelection(messageFormat));
      }
   }
