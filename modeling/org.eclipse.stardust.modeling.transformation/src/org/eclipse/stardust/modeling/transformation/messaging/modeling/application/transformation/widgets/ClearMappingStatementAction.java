...
public class ClearMappingStatementAction extends Action
{
   ...
   public ClearMappingStatementAction(IMessageTransformationApplicationView view,
   ...
   {
      super.run();
      controller.performMappingStatementsRemovement();
   ...
   {
      return controller.isClearMappingStatementAvailable();
   }
