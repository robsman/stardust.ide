 ...
 * @version $Revision$
 */
public class CarnotJavaRenameParticipant extends RenameParticipant
{
   ...
   protected boolean initialize(Object element)
   {
      ...
      return element instanceof IType || element instanceof IMethod || element instanceof IPackageFragment;
   }

   public String getName()
   {
      return Refactoring_Messages.MSG_RenameParticipant;
   }
