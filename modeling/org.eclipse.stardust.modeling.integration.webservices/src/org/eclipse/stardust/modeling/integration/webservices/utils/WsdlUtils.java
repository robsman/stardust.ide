...
public class WsdlUtils
{
      ...
      throws IOException, ProtocolException, UnsupportedEncodingException
   {
      ...
      if (auth != null)
      {
         String authorization = "Basic " + DatatypeConverter.printBase64Binary(auth.getBytes(WsdlUtils.httpAuthCharEncoding)); //$NON-NLS-1$
      ...
      {
         String proxyAuthorization = "Basic " + DatatypeConverter.printBase64Binary(getProxyAuth().getBytes(WsdlUtils.httpAuthCharEncoding)); //$NON-NLS-1$
