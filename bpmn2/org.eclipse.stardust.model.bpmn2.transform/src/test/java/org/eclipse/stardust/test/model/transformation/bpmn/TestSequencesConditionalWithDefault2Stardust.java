 ...
 *
 */
public class TestSequencesConditionalWithDefault2Stardust extends Bpmn2StardustTestSuite {
    ...
    public void testSequenceConditionalWithDefault() {
        final String modelFile = TEST_BPMN_MODEL_DIR + "ConditionalSequenceWithDefault.bpmn";
        final String fileOutput = getResourceFilePath(TEST_MODEL_OUTPUT_DIR) + "testConditionalSequenceWithDefault.xpdl";
