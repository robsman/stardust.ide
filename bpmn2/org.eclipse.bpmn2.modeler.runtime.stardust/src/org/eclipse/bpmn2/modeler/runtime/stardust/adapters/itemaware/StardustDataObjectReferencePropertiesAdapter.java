...
public class StardustDataObjectReferencePropertiesAdapter extends DataObjectReferencePropertiesAdapter
{

   public StardustDataObjectReferencePropertiesAdapter(AdapterFactory adapterFactory, DataObjectReference object) 
   {
      super(adapterFactory, object);

      EStructuralFeature feature = Bpmn2Package.eINSTANCE.getItemAwareElement_ItemSubjectRef();
      setFeatureDescriptor(feature,
         new StardustItemDefinitionRefFeatureDescriptor<DataObjectReference>(this, object, feature)
      );
   }  
}
