...
import static org.eclipse.bpmn2.modeler.runtime.stardust.common.attributes.apps.SynchronousApplicationsCommonAttributes.*;
 ...
 *
 */
public enum SpringBeanAttributes {

	VISIBILITY(Visibility.NAME, Visibility.LABEL, Visibility.getChoices(), "Public", null),
	BEAN_ID("carnot:engine:spring::beanId", Labels.spring_beanId, null, "", null),
	CLASS_NAME("carnot:engine:className", Labels.spring_className, null, "", null),
	METHOD_NAME("carnot:engine:methodName", Labels.spring_methodName, null, "", null),
	...
	private SpringBeanAttributes(String attributeName, String label, Map<String, String> choices, String defaultVal, String dataType) {
