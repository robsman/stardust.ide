 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.QualityControlTypeImpl#getCode <em>Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class QualityControlTypeImpl extends MinimalEObjectImpl.Container implements QualityControlType {
	/**
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getQualityControlType();
	}
	...
	public EList<Code> getCode() {
		if (code == null) {
			code = new EObjectContainmentEList<Code>(Code.class, this, CarnotPackage.QUALITY_CONTROL_TYPE__CODE);
		}
		return code;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.QUALITY_CONTROL_TYPE__CODE:
