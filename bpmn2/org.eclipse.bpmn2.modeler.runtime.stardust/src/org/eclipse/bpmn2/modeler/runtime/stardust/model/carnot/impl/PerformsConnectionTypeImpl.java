 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getReferingToConnections <em>Refering To Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getReferingFromConnections <em>Refering From Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getSourceAnchor <em>Source Anchor</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getTargetAnchor <em>Target Anchor</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getRouting <em>Routing</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getActivitySymbol <em>Activity Symbol</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.PerformsConnectionTypeImpl#getParticipantSymbol <em>Participant Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PerformsConnectionTypeImpl extends MinimalEObjectImpl.Container implements PerformsConnectionType {
	/**
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getPerformsConnectionType();
	}
	...
	public void setElementOid(long newElementOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
	}
	...
	public void unsetElementOid() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
	}
	...
	public void setBorderColor(String newBorderColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__BORDER_COLOR, oldBorderColor, borderColor));
	}
	...
	public void setFillColor(String newFillColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__FILL_COLOR, oldFillColor, fillColor));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__STYLE, oldStyle, style));
	}
	...
	public EList<RefersToConnectionType> getReferingToConnections() {
		if (referingToConnections == null) {
			referingToConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_TO_CONNECTIONS, CarnotPackage.REFERS_TO_CONNECTION_TYPE__TO);
		}
	...
	public EList<RefersToConnectionType> getReferingFromConnections() {
		if (referingFromConnections == null) {
			referingFromConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS, CarnotPackage.REFERS_TO_CONNECTION_TYPE__FROM);
		}
	...
	public void setSourceAnchor(String newSourceAnchor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, sourceAnchor, !oldSourceAnchorESet));
	}
	...
	public void unsetSourceAnchor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.PERFORMS_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, SOURCE_ANCHOR_EDEFAULT, oldSourceAnchorESet));
	}
	...
	public void setTargetAnchor(String newTargetAnchor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, targetAnchor, !oldTargetAnchorESet));
	}
	...
	public void unsetTargetAnchor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.PERFORMS_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, TARGET_ANCHOR_EDEFAULT, oldTargetAnchorESet));
	}
	...
	public void setRouting(RoutingType newRouting) {
		...
		routingESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ROUTING, oldRouting, routing, !oldRoutingESet));
	}
	...
	public void unsetRouting() {
		...
		routingESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ROUTING, oldRouting, ROUTING_EDEFAULT, oldRoutingESet));
	}
	...
	public EList<Coordinates> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EObjectContainmentEList<Coordinates>(Coordinates.class, this, CarnotPackage.PERFORMS_CONNECTION_TYPE__COORDINATES);
		}
		return coordinates;
	}
	...
	public NotificationChain basicSetActivitySymbol(ActivitySymbolType newActivitySymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ACTIVITY_SYMBOL, oldActivitySymbol, newActivitySymbol);
	...
	public void setActivitySymbol(ActivitySymbolType newActivitySymbol) {
		if (newActivitySymbol != activitySymbol) {
			...
			if (activitySymbol != null)
				msgs = ((InternalEObject)activitySymbol).eInverseRemove(this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__PERFORMS_CONNECTIONS, ActivitySymbolType.class, msgs);
			if (newActivitySymbol != null)
				msgs = ((InternalEObject)newActivitySymbol).eInverseAdd(this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__PERFORMS_CONNECTIONS, ActivitySymbolType.class, msgs);
			msgs = basicSetActivitySymbol(newActivitySymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__ACTIVITY_SYMBOL, newActivitySymbol, newActivitySymbol));
	}
	...
	public NotificationChain basicSetParticipantSymbol(IModelParticipantSymbol newParticipantSymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__PARTICIPANT_SYMBOL, oldParticipantSymbol, newParticipantSymbol);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParticipantSymbol(IModelParticipantSymbol newParticipantSymbol) {
		if (newParticipantSymbol != participantSymbol) {
			...
			if (participantSymbol != null)
				msgs = ((InternalEObject)participantSymbol).eInverseRemove(this, CarnotPackage.IMODEL_PARTICIPANT_SYMBOL__PERFORMED_ACTIVITIES, IModelParticipantSymbol.class, msgs);
			if (newParticipantSymbol != null)
				msgs = ((InternalEObject)newParticipantSymbol).eInverseAdd(this, CarnotPackage.IMODEL_PARTICIPANT_SYMBOL__PERFORMED_ACTIVITIES, IModelParticipantSymbol.class, msgs);
			msgs = basicSetParticipantSymbol(newParticipantSymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.PERFORMS_CONNECTION_TYPE__PARTICIPANT_SYMBOL, newParticipantSymbol, newParticipantSymbol));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingToConnections()).basicAdd(otherEnd, msgs);
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingFromConnections()).basicAdd(otherEnd, msgs);
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__ACTIVITY_SYMBOL:
				if (activitySymbol != null)
					msgs = ((InternalEObject)activitySymbol).eInverseRemove(this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__PERFORMS_CONNECTIONS, ActivitySymbolType.class, msgs);
				return basicSetActivitySymbol((ActivitySymbolType)otherEnd, msgs);
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__PARTICIPANT_SYMBOL:
				if (participantSymbol != null)
					msgs = ((InternalEObject)participantSymbol).eInverseRemove(this, CarnotPackage.IMODEL_PARTICIPANT_SYMBOL__PERFORMED_ACTIVITIES, IModelParticipantSymbol.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__COORDINATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__ELEMENT_OID:
				return getElementOid();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__BORDER_COLOR:
				return getBorderColor();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__FILL_COLOR:
				return getFillColor();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__STYLE:
				return getStyle();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
				return getReferingToConnections();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
				return getReferingFromConnections();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__SOURCE_ANCHOR:
				return getSourceAnchor();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__TARGET_ANCHOR:
				return getTargetAnchor();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__ROUTING:
				return getRouting();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE__COORDINATES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.PERFORMS_CONNECTION_TYPE___GET_SOURCE_NODE:
				return getSourceNode();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE___SET_SOURCE_NODE__INODESYMBOL:
				setSourceNode((INodeSymbol)arguments.get(0));
				return null;
			case CarnotPackage.PERFORMS_CONNECTION_TYPE___GET_TARGET_NODE:
				return getTargetNode();
			case CarnotPackage.PERFORMS_CONNECTION_TYPE___SET_TARGET_NODE__INODESYMBOL:
