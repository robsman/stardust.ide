 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getReferingToConnections <em>Refering To Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getReferingFromConnections <em>Refering From Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getSourceAnchor <em>Source Anchor</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getTargetAnchor <em>Target Anchor</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getRouting <em>Routing</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getProcessSymbol <em>Process Symbol</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.SubProcessOfConnectionTypeImpl#getSubprocessSymbol <em>Subprocess Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubProcessOfConnectionTypeImpl extends MinimalEObjectImpl.Container implements SubProcessOfConnectionType {
	/**
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getSubProcessOfConnectionType();
	}
	...
	public void setElementOid(long newElementOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
	}
	...
	public void unsetElementOid() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
	}
	...
	public void setBorderColor(String newBorderColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__BORDER_COLOR, oldBorderColor, borderColor));
	}
	...
	public void setFillColor(String newFillColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__FILL_COLOR, oldFillColor, fillColor));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__STYLE, oldStyle, style));
	}
	...
	public EList<RefersToConnectionType> getReferingToConnections() {
		if (referingToConnections == null) {
			referingToConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_TO_CONNECTIONS, CarnotPackage.REFERS_TO_CONNECTION_TYPE__TO);
		}
	...
	public EList<RefersToConnectionType> getReferingFromConnections() {
		if (referingFromConnections == null) {
			referingFromConnections = new EObjectWithInverseEList<RefersToConnectionType>(RefersToConnectionType.class, this, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS, CarnotPackage.REFERS_TO_CONNECTION_TYPE__FROM);
		}
	...
	public void setSourceAnchor(String newSourceAnchor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, sourceAnchor, !oldSourceAnchorESet));
	}
	...
	public void unsetSourceAnchor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SOURCE_ANCHOR, oldSourceAnchor, SOURCE_ANCHOR_EDEFAULT, oldSourceAnchorESet));
	}
	...
	public void setTargetAnchor(String newTargetAnchor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, targetAnchor, !oldTargetAnchorESet));
	}
	...
	public void unsetTargetAnchor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__TARGET_ANCHOR, oldTargetAnchor, TARGET_ANCHOR_EDEFAULT, oldTargetAnchorESet));
	}
	...
	public void setRouting(RoutingType newRouting) {
		...
		routingESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ROUTING, oldRouting, routing, !oldRoutingESet));
	}
	...
	public void unsetRouting() {
		...
		routingESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ROUTING, oldRouting, ROUTING_EDEFAULT, oldRoutingESet));
	}
	...
	public EList<Coordinates> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EObjectContainmentEList<Coordinates>(Coordinates.class, this, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__COORDINATES);
		}
		return coordinates;
	}
	...
	public NotificationChain basicSetProcessSymbol(ProcessSymbolType newProcessSymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__PROCESS_SYMBOL, oldProcessSymbol, newProcessSymbol);
	...
	public void setProcessSymbol(ProcessSymbolType newProcessSymbol) {
		if (newProcessSymbol != processSymbol) {
			...
			if (processSymbol != null)
				msgs = ((InternalEObject)processSymbol).eInverseRemove(this, CarnotPackage.PROCESS_SYMBOL_TYPE__SUB_PROCESSES, ProcessSymbolType.class, msgs);
			if (newProcessSymbol != null)
				msgs = ((InternalEObject)newProcessSymbol).eInverseAdd(this, CarnotPackage.PROCESS_SYMBOL_TYPE__SUB_PROCESSES, ProcessSymbolType.class, msgs);
			msgs = basicSetProcessSymbol(newProcessSymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__PROCESS_SYMBOL, newProcessSymbol, newProcessSymbol));
	}
	...
	public NotificationChain basicSetSubprocessSymbol(ProcessSymbolType newSubprocessSymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SUBPROCESS_SYMBOL, oldSubprocessSymbol, newSubprocessSymbol);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSubprocessSymbol(ProcessSymbolType newSubprocessSymbol) {
		if (newSubprocessSymbol != subprocessSymbol) {
			...
			if (subprocessSymbol != null)
				msgs = ((InternalEObject)subprocessSymbol).eInverseRemove(this, CarnotPackage.PROCESS_SYMBOL_TYPE__PARENT_PROCESSES, ProcessSymbolType.class, msgs);
			if (newSubprocessSymbol != null)
				msgs = ((InternalEObject)newSubprocessSymbol).eInverseAdd(this, CarnotPackage.PROCESS_SYMBOL_TYPE__PARENT_PROCESSES, ProcessSymbolType.class, msgs);
			msgs = basicSetSubprocessSymbol(newSubprocessSymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SUBPROCESS_SYMBOL, newSubprocessSymbol, newSubprocessSymbol));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingToConnections()).basicAdd(otherEnd, msgs);
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferingFromConnections()).basicAdd(otherEnd, msgs);
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__PROCESS_SYMBOL:
				if (processSymbol != null)
					msgs = ((InternalEObject)processSymbol).eInverseRemove(this, CarnotPackage.PROCESS_SYMBOL_TYPE__SUB_PROCESSES, ProcessSymbolType.class, msgs);
				return basicSetProcessSymbol((ProcessSymbolType)otherEnd, msgs);
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SUBPROCESS_SYMBOL:
				if (subprocessSymbol != null)
					msgs = ((InternalEObject)subprocessSymbol).eInverseRemove(this, CarnotPackage.PROCESS_SYMBOL_TYPE__PARENT_PROCESSES, ProcessSymbolType.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__COORDINATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ELEMENT_OID:
				return getElementOid();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__BORDER_COLOR:
				return getBorderColor();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__FILL_COLOR:
				return getFillColor();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__STYLE:
				return getStyle();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_TO_CONNECTIONS:
				return getReferingToConnections();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__REFERING_FROM_CONNECTIONS:
				return getReferingFromConnections();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__SOURCE_ANCHOR:
				return getSourceAnchor();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__TARGET_ANCHOR:
				return getTargetAnchor();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__ROUTING:
				return getRouting();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE__COORDINATES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE___GET_SOURCE_NODE:
				return getSourceNode();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE___SET_SOURCE_NODE__INODESYMBOL:
				setSourceNode((INodeSymbol)arguments.get(0));
				return null;
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE___GET_TARGET_NODE:
				return getTargetNode();
			case CarnotPackage.SUB_PROCESS_OF_CONNECTION_TYPE___SET_TARGET_NODE__INODESYMBOL:
