...
import org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.AbstractEventAction;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#isIsPredefined <em>Is Predefined</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getActionClass <em>Action Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#isActivityAction <em>Activity Action</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getPanelClass <em>Panel Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#isProcessAction <em>Process Action</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getSupportedConditionTypes <em>Supported Condition Types</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getUnsupportedContexts <em>Unsupported Contexts</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.EventActionTypeTypeImpl#getActionInstances <em>Action Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EventActionTypeTypeImpl extends MinimalEObjectImpl.Container implements EventActionTypeType {
	/**
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getEventActionTypeType();
	}
	...
	public void setElementOid(long newElementOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
	}
	...
	public void unsetElementOid() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
	}
	...
	public void setId(String newId) {
		...
		idESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ID, oldId, id, !oldIdESet));
	}
	...
	public void unsetId() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ID, oldId, ID_EDEFAULT, oldIdESet));
	}
	...
	public void setName(String newName) {
		...
		nameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	public EList<AttributeType> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<AttributeType>(AttributeType.class, this, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public NotificationChain basicSetDescription(DescriptionType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(DescriptionType newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setIsPredefined(boolean newIsPredefined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, isPredefined, !oldIsPredefinedESet));
	}
	...
	public void unsetIsPredefined() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, IS_PREDEFINED_EDEFAULT, oldIsPredefinedESet));
	}
	...
	public void setActionClass(String newActionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTION_CLASS, oldActionClass, actionClass));
	}
	...
	public void setActivityAction(boolean newActivityAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTIVITY_ACTION, oldActivityAction, activityAction, !oldActivityActionESet));
	}
	...
	public void unsetActivityAction() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTIVITY_ACTION, oldActivityAction, ACTIVITY_ACTION_EDEFAULT, oldActivityActionESet));
	}
	...
	public void setPanelClass(String newPanelClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__PANEL_CLASS, oldPanelClass, panelClass));
	}
	...
	public void setProcessAction(boolean newProcessAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__PROCESS_ACTION, oldProcessAction, processAction, !oldProcessActionESet));
	}
	...
	public void unsetProcessAction() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__PROCESS_ACTION, oldProcessAction, PROCESS_ACTION_EDEFAULT, oldProcessActionESet));
	}
	...
	public void setSupportedConditionTypes(String newSupportedConditionTypes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__SUPPORTED_CONDITION_TYPES, oldSupportedConditionTypes, supportedConditionTypes));
	}
	...
	public void setUnsupportedContexts(String newUnsupportedContexts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.EVENT_ACTION_TYPE_TYPE__UNSUPPORTED_CONTEXTS, oldUnsupportedContexts, unsupportedContexts));
	}
	...
	public EList<AbstractEventAction> getActionInstances() {
		if (actionInstances == null) {
			actionInstances = new EObjectWithInverseResolvingEList<AbstractEventAction>(AbstractEventAction.class, this, CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTION_INSTANCES, CarnotPackage.ABSTRACT_EVENT_ACTION__TYPE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTION_INSTANCES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ELEMENT_OID:
				return getElementOid();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ID:
				return getId();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__NAME:
				return getName();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ATTRIBUTE:
				return getAttribute();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__DESCRIPTION:
				return getDescription();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__IS_PREDEFINED:
				return isIsPredefined();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTION_CLASS:
				return getActionClass();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ACTIVITY_ACTION:
				return isActivityAction();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__PANEL_CLASS:
				return getPanelClass();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__PROCESS_ACTION:
				return isProcessAction();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__SUPPORTED_CONDITION_TYPES:
				return getSupportedConditionTypes();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE__UNSUPPORTED_CONTEXTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ID: return CarnotPackage.IIDENTIFIABLE_ELEMENT__ID;
				case CarnotPackage.EVENT_ACTION_TYPE_TYPE__NAME: return CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.EVENT_ACTION_TYPE_TYPE__ATTRIBUTE: return CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__ID: return CarnotPackage.EVENT_ACTION_TYPE_TYPE__ID;
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME: return CarnotPackage.EVENT_ACTION_TYPE_TYPE__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE: return CarnotPackage.EVENT_ACTION_TYPE_TYPE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE___GET_EXTENSION_POINT_ID:
				return getExtensionPointId();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE___GET_TYPED_ELEMENTS:
				return getTypedElements();
			case CarnotPackage.EVENT_ACTION_TYPE_TYPE___GET_SYMBOLS:
				return getSymbols();
		}
