...
public class StardustDataInputPropertiesAdapter extends DataInputPropertiesAdapter
{

   public StardustDataInputPropertiesAdapter(AdapterFactory adapterFactory, DataInput object) 
   {
      super(adapterFactory, object);

      EStructuralFeature feature = Bpmn2Package.eINSTANCE.getItemAwareElement_ItemSubjectRef();
      setFeatureDescriptor(feature,
         new StardustItemDefinitionRefFeatureDescriptor<DataInput>(this, object, feature)
      );
   }
}
