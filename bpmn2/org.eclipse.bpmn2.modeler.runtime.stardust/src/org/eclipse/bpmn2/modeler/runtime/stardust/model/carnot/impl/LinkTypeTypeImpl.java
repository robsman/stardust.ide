...
import org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.LinkCardinality;
import org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.LinkColor;
import org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.LinkEndStyle;
import org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.LinkLineStyle;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#isIsPredefined <em>Is Predefined</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getSourceRole <em>Source Role</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getSourceClass <em>Source Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getSourceCardinality <em>Source Cardinality</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getTargetRole <em>Target Role</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getTargetClass <em>Target Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getTargetCardinality <em>Target Cardinality</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getLineStyle <em>Line Style</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getLineColor <em>Line Color</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getSourceSymbol <em>Source Symbol</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getTargetSymbol <em>Target Symbol</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#isShowRoleNames <em>Show Role Names</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#isShowLinkTypeName <em>Show Link Type Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.LinkTypeTypeImpl#getLinkInstances <em>Link Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkTypeTypeImpl extends MinimalEObjectImpl.Container implements LinkTypeType {
	/**
	 ...
	 * @ordered
	 */
	protected static final LinkCardinality SOURCE_CARDINALITY_EDEFAULT = LinkCardinality.UNKNOWN;
	 ...
	 * @ordered
	 */
	protected static final LinkCardinality TARGET_CARDINALITY_EDEFAULT = LinkCardinality.UNKNOWN;
	 ...
	 * @ordered
	 */
	protected static final LinkLineStyle LINE_STYLE_EDEFAULT = LinkLineStyle.UNKNOWN;
	 ...
	 * @ordered
	 */
	protected static final LinkColor LINE_COLOR_EDEFAULT = LinkColor.UNKNOWN;
	 ...
	 * @ordered
	 */
	protected static final LinkEndStyle SOURCE_SYMBOL_EDEFAULT = LinkEndStyle.UNKNOWN;
	 ...
	 * @ordered
	 */
	protected static final LinkEndStyle TARGET_SYMBOL_EDEFAULT = LinkEndStyle.UNKNOWN;
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getLinkTypeType();
	}
	...
	public void setElementOid(long newElementOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
	}
	...
	public void unsetElementOid() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
	}
	...
	public void setId(String newId) {
		...
		idESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__ID, oldId, id, !oldIdESet));
	}
	...
	public void unsetId() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__ID, oldId, ID_EDEFAULT, oldIdESet));
	}
	...
	public void setName(String newName) {
		...
		nameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	public EList<AttributeType> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<AttributeType>(AttributeType.class, this, CarnotPackage.LINK_TYPE_TYPE__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public NotificationChain basicSetDescription(DescriptionType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(DescriptionType newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setIsPredefined(boolean newIsPredefined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, isPredefined, !oldIsPredefinedESet));
	}
	...
	public void unsetIsPredefined() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, IS_PREDEFINED_EDEFAULT, oldIsPredefinedESet));
	}
	...
	public void setSourceRole(String newSourceRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SOURCE_ROLE, oldSourceRole, sourceRole));
	}
	...
	public void setSourceClass(String newSourceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SOURCE_CLASS, oldSourceClass, sourceClass));
	}
	...
	public void setSourceCardinality(LinkCardinality newSourceCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SOURCE_CARDINALITY, oldSourceCardinality, sourceCardinality));
	}
	...
	public void setTargetRole(String newTargetRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__TARGET_ROLE, oldTargetRole, targetRole));
	}
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__TARGET_CLASS, oldTargetClass, targetClass));
	}
	...
	public void setTargetCardinality(LinkCardinality newTargetCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__TARGET_CARDINALITY, oldTargetCardinality, targetCardinality));
	}
	...
	public void setLineStyle(LinkLineStyle newLineStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__LINE_STYLE, oldLineStyle, lineStyle));
	}
	...
	public void setLineColor(LinkColor newLineColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__LINE_COLOR, oldLineColor, lineColor));
	}
	...
	public void setSourceSymbol(LinkEndStyle newSourceSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SOURCE_SYMBOL, oldSourceSymbol, sourceSymbol));
	}
	...
	public void setTargetSymbol(LinkEndStyle newTargetSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__TARGET_SYMBOL, oldTargetSymbol, targetSymbol));
	}
	...
	public void setShowRoleNames(boolean newShowRoleNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SHOW_ROLE_NAMES, oldShowRoleNames, showRoleNames, !oldShowRoleNamesESet));
	}
	...
	public void unsetShowRoleNames() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__SHOW_ROLE_NAMES, oldShowRoleNames, SHOW_ROLE_NAMES_EDEFAULT, oldShowRoleNamesESet));
	}
	...
	public void setShowLinkTypeName(boolean newShowLinkTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.LINK_TYPE_TYPE__SHOW_LINK_TYPE_NAME, oldShowLinkTypeName, showLinkTypeName, !oldShowLinkTypeNameESet));
	}
	...
	public void unsetShowLinkTypeName() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.LINK_TYPE_TYPE__SHOW_LINK_TYPE_NAME, oldShowLinkTypeName, SHOW_LINK_TYPE_NAME_EDEFAULT, oldShowLinkTypeNameESet));
	}
	...
	public EList<GenericLinkConnectionType> getLinkInstances() {
		if (linkInstances == null) {
			linkInstances = new EObjectWithInverseResolvingEList<GenericLinkConnectionType>(GenericLinkConnectionType.class, this, CarnotPackage.LINK_TYPE_TYPE__LINK_INSTANCES, CarnotPackage.GENERIC_LINK_CONNECTION_TYPE__LINK_TYPE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.LINK_TYPE_TYPE__LINK_INSTANCES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.LINK_TYPE_TYPE__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarnotPackage.LINK_TYPE_TYPE__ELEMENT_OID:
				return getElementOid();
			case CarnotPackage.LINK_TYPE_TYPE__ID:
				return getId();
			case CarnotPackage.LINK_TYPE_TYPE__NAME:
				return getName();
			case CarnotPackage.LINK_TYPE_TYPE__ATTRIBUTE:
				return getAttribute();
			case CarnotPackage.LINK_TYPE_TYPE__DESCRIPTION:
				return getDescription();
			case CarnotPackage.LINK_TYPE_TYPE__IS_PREDEFINED:
				return isIsPredefined();
			case CarnotPackage.LINK_TYPE_TYPE__SOURCE_ROLE:
				return getSourceRole();
			case CarnotPackage.LINK_TYPE_TYPE__SOURCE_CLASS:
				return getSourceClass();
			case CarnotPackage.LINK_TYPE_TYPE__SOURCE_CARDINALITY:
				return getSourceCardinality();
			case CarnotPackage.LINK_TYPE_TYPE__TARGET_ROLE:
				return getTargetRole();
			case CarnotPackage.LINK_TYPE_TYPE__TARGET_CLASS:
				return getTargetClass();
			case CarnotPackage.LINK_TYPE_TYPE__TARGET_CARDINALITY:
				return getTargetCardinality();
			case CarnotPackage.LINK_TYPE_TYPE__LINE_STYLE:
				return getLineStyle();
			case CarnotPackage.LINK_TYPE_TYPE__LINE_COLOR:
				return getLineColor();
			case CarnotPackage.LINK_TYPE_TYPE__SOURCE_SYMBOL:
				return getSourceSymbol();
			case CarnotPackage.LINK_TYPE_TYPE__TARGET_SYMBOL:
				return getTargetSymbol();
			case CarnotPackage.LINK_TYPE_TYPE__SHOW_ROLE_NAMES:
				return isShowRoleNames();
			case CarnotPackage.LINK_TYPE_TYPE__SHOW_LINK_TYPE_NAME:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.LINK_TYPE_TYPE__ID: return CarnotPackage.IIDENTIFIABLE_ELEMENT__ID;
				case CarnotPackage.LINK_TYPE_TYPE__NAME: return CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.LINK_TYPE_TYPE__ATTRIBUTE: return CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__ID: return CarnotPackage.LINK_TYPE_TYPE__ID;
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME: return CarnotPackage.LINK_TYPE_TYPE__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE: return CarnotPackage.LINK_TYPE_TYPE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.LINK_TYPE_TYPE___GET_EXTENSION_POINT_ID:
				return getExtensionPointId();
			case CarnotPackage.LINK_TYPE_TYPE___GET_TYPED_ELEMENTS:
				return getTypedElements();
			case CarnotPackage.LINK_TYPE_TYPE___GET_SYMBOLS:
				return getSymbols();
		}
