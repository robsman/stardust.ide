 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.CarnotPackage#getRoutingType()
...
public enum RoutingType implements Enumerator {
	 ...
	 * @ordered
	 */
	SHORTEST_PATH(1, "ShortestPath", "ShortestPath"),
	 ...
	 * @ordered
	 */
	public static final int SHORTEST_PATH_VALUE = 1;
	...
	public static RoutingType get(int value) {
		switch (value) {
			...
			case SHORTEST_PATH_VALUE: return SHORTEST_PATH;
