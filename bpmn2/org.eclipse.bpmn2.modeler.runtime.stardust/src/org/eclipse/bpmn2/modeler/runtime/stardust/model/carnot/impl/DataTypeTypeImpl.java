 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getElementOid <em>Element Oid</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#isIsPredefined <em>Is Predefined</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getAccessPathEditor <em>Access Path Editor</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getEvaluator <em>Evaluator</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getInstanceClass <em>Instance Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getPanelClass <em>Panel Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#isReadable <em>Readable</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getStorageStrategy <em>Storage Strategy</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getValidatorClass <em>Validator Class</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getValueCreator <em>Value Creator</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#isWritable <em>Writable</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.DataTypeTypeImpl#getData <em>Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeTypeImpl extends MinimalEObjectImpl.Container implements DataTypeType {
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getDataTypeType();
	}
	...
	public void setElementOid(long newElementOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__ELEMENT_OID, oldElementOid, elementOid, !oldElementOidESet));
	}
	...
	public void unsetElementOid() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__ELEMENT_OID, oldElementOid, ELEMENT_OID_EDEFAULT, oldElementOidESet));
	}
	...
	public void setId(String newId) {
		...
		idESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__ID, oldId, id, !oldIdESet));
	}
	...
	public void unsetId() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__ID, oldId, ID_EDEFAULT, oldIdESet));
	}
	...
	public void setName(String newName) {
		...
		nameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	public EList<AttributeType> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<AttributeType>(AttributeType.class, this, CarnotPackage.DATA_TYPE_TYPE__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public NotificationChain basicSetDescription(DescriptionType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(DescriptionType newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setIsPredefined(boolean newIsPredefined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, isPredefined, !oldIsPredefinedESet));
	}
	...
	public void unsetIsPredefined() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__IS_PREDEFINED, oldIsPredefined, IS_PREDEFINED_EDEFAULT, oldIsPredefinedESet));
	}
	...
	public void setAccessPathEditor(String newAccessPathEditor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__ACCESS_PATH_EDITOR, oldAccessPathEditor, accessPathEditor));
	}
	...
	public void setEvaluator(String newEvaluator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__EVALUATOR, oldEvaluator, evaluator));
	}
	...
	public void setInstanceClass(String newInstanceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__INSTANCE_CLASS, oldInstanceClass, instanceClass));
	}
	...
	public void setPanelClass(String newPanelClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__PANEL_CLASS, oldPanelClass, panelClass));
	}
	...
	public void setReadable(boolean newReadable) {
		...
		readableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__READABLE, oldReadable, readable, !oldReadableESet));
	}
	...
	public void unsetReadable() {
		...
		readableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__READABLE, oldReadable, READABLE_EDEFAULT, oldReadableESet));
	}
	...
	public void setStorageStrategy(String newStorageStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__STORAGE_STRATEGY, oldStorageStrategy, storageStrategy));
	}
	...
	public void setValidatorClass(String newValidatorClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__VALIDATOR_CLASS, oldValidatorClass, validatorClass));
	}
	...
	public void setValueCreator(String newValueCreator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__VALUE_CREATOR, oldValueCreator, valueCreator));
	}
	...
	public void setWritable(boolean newWritable) {
		...
		writableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.DATA_TYPE_TYPE__WRITABLE, oldWritable, writable, !oldWritableESet));
	}
	...
	public void unsetWritable() {
		...
		writableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CarnotPackage.DATA_TYPE_TYPE__WRITABLE, oldWritable, WRITABLE_EDEFAULT, oldWritableESet));
	}
	...
	public EList<DataType> getData() {
		if (data == null) {
			data = new EObjectWithInverseResolvingEList<DataType>(DataType.class, this, CarnotPackage.DATA_TYPE_TYPE__DATA, CarnotPackage.DATA_TYPE__TYPE);
		}
		return data;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.DATA_TYPE_TYPE__DATA:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CarnotPackage.DATA_TYPE_TYPE__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CarnotPackage.DATA_TYPE_TYPE__ELEMENT_OID:
				return getElementOid();
			case CarnotPackage.DATA_TYPE_TYPE__ID:
				return getId();
			case CarnotPackage.DATA_TYPE_TYPE__NAME:
				return getName();
			case CarnotPackage.DATA_TYPE_TYPE__ATTRIBUTE:
				return getAttribute();
			case CarnotPackage.DATA_TYPE_TYPE__DESCRIPTION:
				return getDescription();
			case CarnotPackage.DATA_TYPE_TYPE__IS_PREDEFINED:
				return isIsPredefined();
			case CarnotPackage.DATA_TYPE_TYPE__ACCESS_PATH_EDITOR:
				return getAccessPathEditor();
			case CarnotPackage.DATA_TYPE_TYPE__EVALUATOR:
				return getEvaluator();
			case CarnotPackage.DATA_TYPE_TYPE__INSTANCE_CLASS:
				return getInstanceClass();
			case CarnotPackage.DATA_TYPE_TYPE__PANEL_CLASS:
				return getPanelClass();
			case CarnotPackage.DATA_TYPE_TYPE__READABLE:
				return isReadable();
			case CarnotPackage.DATA_TYPE_TYPE__STORAGE_STRATEGY:
				return getStorageStrategy();
			case CarnotPackage.DATA_TYPE_TYPE__VALIDATOR_CLASS:
				return getValidatorClass();
			case CarnotPackage.DATA_TYPE_TYPE__VALUE_CREATOR:
				return getValueCreator();
			case CarnotPackage.DATA_TYPE_TYPE__WRITABLE:
				return isWritable();
			case CarnotPackage.DATA_TYPE_TYPE__DATA:
				return getData();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.DATA_TYPE_TYPE__ID: return CarnotPackage.IIDENTIFIABLE_ELEMENT__ID;
				case CarnotPackage.DATA_TYPE_TYPE__NAME: return CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (derivedFeatureID) {
				case CarnotPackage.DATA_TYPE_TYPE__ATTRIBUTE: return CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IIdentifiableElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__ID: return CarnotPackage.DATA_TYPE_TYPE__ID;
				case CarnotPackage.IIDENTIFIABLE_ELEMENT__NAME: return CarnotPackage.DATA_TYPE_TYPE__NAME;
				default: return -1;
			}
		}
		if (baseClass == IExtensibleElement.class) {
			switch (baseFeatureID) {
				case CarnotPackage.IEXTENSIBLE_ELEMENT__ATTRIBUTE: return CarnotPackage.DATA_TYPE_TYPE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.DATA_TYPE_TYPE___GET_EXTENSION_POINT_ID:
				return getExtensionPointId();
			case CarnotPackage.DATA_TYPE_TYPE___GET_TYPED_ELEMENTS:
				return getTypedElements();
			case CarnotPackage.DATA_TYPE_TYPE___GET_SYMBOLS:
				return getSymbols();
		}
