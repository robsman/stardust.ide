...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activity Symbol Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.ActivitySymbolTypeImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.ActivitySymbolTypeImpl#getPerformsConnections <em>Performs Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.ActivitySymbolTypeImpl#getExecutedByConnections <em>Executed By Connections</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.ActivitySymbolTypeImpl#getDataMappings <em>Data Mappings</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.stardust.model.carnot.impl.ActivitySymbolTypeImpl#getGatewaySymbols <em>Gateway Symbols</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivitySymbolTypeImpl extends IFlowObjectSymbolImpl implements ActivitySymbolType {
	...
	protected EClass eStaticClass() {
		return CarnotPackage.eINSTANCE.getActivitySymbolType();
	}
	...
	public NotificationChain basicSetActivity(ActivityType newActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CarnotPackage.ACTIVITY_SYMBOL_TYPE__ACTIVITY, oldActivity, newActivity);
	...
	public void setActivity(ActivityType newActivity) {
		if (newActivity != activity) {
			...
			if (activity != null)
				msgs = ((InternalEObject)activity).eInverseRemove(this, CarnotPackage.ACTIVITY_TYPE__ACTIVITY_SYMBOLS, ActivityType.class, msgs);
			if (newActivity != null)
				msgs = ((InternalEObject)newActivity).eInverseAdd(this, CarnotPackage.ACTIVITY_TYPE__ACTIVITY_SYMBOLS, ActivityType.class, msgs);
			msgs = basicSetActivity(newActivity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarnotPackage.ACTIVITY_SYMBOL_TYPE__ACTIVITY, newActivity, newActivity));
	}
	...
	public EList<PerformsConnectionType> getPerformsConnections() {
		if (performsConnections == null) {
			performsConnections = new EObjectWithInverseEList<PerformsConnectionType>(PerformsConnectionType.class, this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__PERFORMS_CONNECTIONS, CarnotPackage.PERFORMS_CONNECTION_TYPE__ACTIVITY_SYMBOL);
		}
	...
	public EList<ExecutedByConnectionType> getExecutedByConnections() {
		if (executedByConnections == null) {
			executedByConnections = new EObjectWithInverseEList<ExecutedByConnectionType>(ExecutedByConnectionType.class, this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__EXECUTED_BY_CONNECTIONS, CarnotPackage.EXECUTED_BY_CONNECTION_TYPE__ACTIVITY_SYMBOL);
		}
	...
	public EList<DataMappingConnectionType> getDataMappings() {
		if (dataMappings == null) {
			dataMappings = new EObjectWithInverseEList<DataMappingConnectionType>(DataMappingConnectionType.class, this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__DATA_MAPPINGS, CarnotPackage.DATA_MAPPING_CONNECTION_TYPE__ACTIVITY_SYMBOL);
		}
		return dataMappings;
	}
	...
	public EList<GatewaySymbol> getGatewaySymbols() {
		if (gatewaySymbols == null) {
			gatewaySymbols = new EObjectWithInverseResolvingEList<GatewaySymbol>(GatewaySymbol.class, this, CarnotPackage.ACTIVITY_SYMBOL_TYPE__GATEWAY_SYMBOLS, CarnotPackage.GATEWAY_SYMBOL__ACTIVITY_SYMBOL);
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IModelElementNodeSymbol.class) {
			switch (baseOperationID) {
				case CarnotPackage.IMODEL_ELEMENT_NODE_SYMBOL___GET_MODEL_ELEMENT: return CarnotPackage.ACTIVITY_SYMBOL_TYPE___GET_MODEL_ELEMENT;
				case CarnotPackage.IMODEL_ELEMENT_NODE_SYMBOL___SET_MODEL_ELEMENT__IIDENTIFIABLEMODELELEMENT: return CarnotPackage.ACTIVITY_SYMBOL_TYPE___SET_MODEL_ELEMENT__IIDENTIFIABLEMODELELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CarnotPackage.ACTIVITY_SYMBOL_TYPE___GET_MODEL_ELEMENT:
				return getModelElement();
			case CarnotPackage.ACTIVITY_SYMBOL_TYPE___SET_MODEL_ELEMENT__IIDENTIFIABLEMODELELEMENT:
