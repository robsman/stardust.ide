...
public class SdbpmnFactoryImpl extends EFactoryImpl implements SdbpmnFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SdbpmnPackage.STARDUST_PROCESS_TYPE: return createStardustProcessType();
	 ...
	 * @generated
	 */
	public StardustProcessType createStardustProcessType() {
		StardustProcessTypeImpl stardustProcessType = new StardustProcessTypeImpl();
		return stardustProcessType;
	}
